...
if chapter == 4:
	...
	if args.figureofmerit == "electron":
		...
		axs[1].set_yticklabels([zero,tenthousands, two+times+tenthousands, three+times+tenthousands])
		...
		axs[2].set_yticks([0, 50000, 100000, 150000, 200000, 250000])
		axs[2].set_yticklabels([zero,five+times+tenthousands, tenthousands, one+point+five+times+tenthousands, two+times+tenthousands, two+point+five+times+tenthousands])
		...
		axs[2].set_yticks([0, 200000, 40000, 600000])
		...
		axs[0].set_yticklabels([zero, tenthousands, two+times+tenthousands, three+times+tenthousand, four+times+tenthousands, five+times+tenthousands])
