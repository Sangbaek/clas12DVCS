...
if chapter == 4:
	...
	if args.figureofmerit == "electron":
		...
		axs[0].set_yticks(['', 20000, 40000, 60000])
		...
		axs[1].set_yticks(['', 5000, 10000, 15000, 20000])
		...
		axs[2].set_yticks(['', 100000, 200000, 300000, 400000])
		...
		axs[3].set_yticks(['', 100000, 200000, 300000])
		...
		axs[0].set_yticks(['', 20000, 40000, 60000, 80000, 100000])
		...
		axs[1].set_yticks(['', 5000, 10000, 15000, 20000, 25000])
		...
		axs[2].set_yticks(['', 50000, 100000, 150000, 200000])
		...
		axs[3].set_yticks(['', 50000, 100000, 150000])
		...
		axs[0].set_yticks(['', 10000, 20000, 30000, 40000, 50000])
		...
		axs[2].set_yticks(['', 100000, 200000, 300000])
		...
		axs[3].set_yticks(['', 50000, 100000, 150000, 200000, 250000])
