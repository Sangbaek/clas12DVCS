...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		print("$\gamma$ PCAL1 &{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%\\\\".format(100*InbExp_effect_Gpcal, 100*InbSim_effect_Gpcal, 100*InbExp_effect_Gpcal/InbSim_effect_Gpcal, 100*OutbExp_effect_Gpcal, 100*OutbSim_effect_Gpcal, 100*OutbExp_effect_Gpcal/OutbSim_effect_Gpcal2))
