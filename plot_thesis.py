...
if chapter == 4:
	...
	if args.figureofmerit == "electron":
		...
		#plt.suptitle("FD "+rx = 0.1ided in "+r"$\delta p-p$"+".", size = 40)
		plt.tight_layout()
		...
		axs[0, 1].set_title("(b)", loc = 'left')
		axs[0, 2].set_title("(c)", loc = 'left')
		#plt.suptitle("FD "+rx = 0.1ided in "+r"$\theta_{\mathrm{DC, region 1}}-p$"+".", fontsize = 40)
		plt.tight_layout()
