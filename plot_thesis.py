...
if chapter == 4:
	...
	if args.figureofmerit == "electron":
		...
		axs[0].set_yticklabels(['',two+times+tenthousands, four+times+tenthousands, six+times+tenthousands, eight+times+tenthousands, hundredthousands])
		...
		axs[1].set_yticklabels(['',five+times+tenthousands, tenthousands, one+point+five+times+tenthousands, two+times+tenthousands, two+point+five+times+tenthousands])
		...
		axs[2].set_yticklabels(['',five+times+tenthousands, tenthousands, one+point+five+times+tenthousands, two+times+tenthousands])
		...
		axs[3].set_yticklabels(['',five+times+tenthousands, tenthousands, one+point+five+times+tenthousands])
		...
		axs[0].set_yticklabels(['', tenthousands, two+times+tenthousands, three+times+tenthousands, four+times+tenthousands, five+times+tenthousands])
		...
		axs[2].set_yticklabels(['',hundredthousands, two+times+hundredthousands, three+times+hundredthousands])
		...
		axs[3].set_yticklabels(['',five+times+tenthousands, tenthousands, one+point+five+times+tenthousands, two+times+tenthousands, two+point+five+times+tenthousands])
		...
		axs[0].set_yticklabels(['',five+times+thousand, thousand, one+point+five+times+thousand, two+times+thousand, two+point+five+times+thousand])
		...
		axs[1].set_yticklabels(['',two+times+thousand, four+times+thousand, six+times+thousand, eight+times+thousand, tenthousands, one+point+two+times+tenthousands])
		...
		axs[2].set_yticklabels(['',two+times+hundredthousands, four+times+hundredthousands, six+times+hundredthousands])
		...
		axs[3].set_yticklabels(['',hundredthousands, two+times+hundredthousands, three+times+hundredthousands, four+times+hundredthousands])
...
if chapter == 5:
	...
	if args.figureofmerit == "tables":
		...
		print("&(FD, FD)&(CD, FD)&(CD, FT)&(FD, FD)&(CD, FD)&(CD, FT)\\\\hline")
		print("$lb_{MM^2_{e'p'}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MM2_ep_lb"], cuts_dvcs_CD_Inb_3sigma["MM2_ep_lb"], cuts_dvcs_CDFT_Inb_3sigma["MM2_ep_lb"], cuts_dvcs_FD_Outb_3sigma["MM2_ep_lb"], cuts_dvcs_CD_Outb_3sigma["MM2_ep_lb"], cuts_dvcs_CDFT_Outb_3sigma["MM2_ep_lb"]))
		print("$ub_{MM^2_{e'p'}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MM2_ep_ub"], cuts_dvcs_CD_Inb_3sigma["MM2_ep_ub"], cuts_dvcs_CDFT_Inb_3sigma["MM2_ep_ub"], cuts_dvcs_FD_Outb_3sigma["MM2_ep_ub"], cuts_dvcs_CD_Outb_3sigma["MM2_ep_ub"], cuts_dvcs_CDFT_Outb_3sigma["MM2_ep_ub"]))
		print("$lb_{MM^2_{e'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MM2_eg_lb"], cuts_dvcs_CD_Inb_3sigma["MM2_eg_lb"], cuts_dvcs_CDFT_Inb_3sigma["MM2_eg_lb"], cuts_dvcs_FD_Outb_3sigma["MM2_eg_lb"], cuts_dvcs_CD_Outb_3sigma["MM2_eg_lb"], cuts_dvcs_CDFT_Outb_3sigma["MM2_eg_lb"]))
		print("$ub_{MM^2_{e'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MM2_eg_ub"], cuts_dvcs_CD_Inb_3sigma["MM2_eg_ub"], cuts_dvcs_CDFT_Inb_3sigma["MM2_eg_ub"], cuts_dvcs_FD_Outb_3sigma["MM2_eg_ub"], cuts_dvcs_CD_Outb_3sigma["MM2_eg_ub"], cuts_dvcs_CDFT_Outb_3sigma["MM2_eg_ub"]))
		print("$lb_{MM^2_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MM2_epg_lb"], cuts_dvcs_CD_Inb_3sigma["MM2_epg_lb"], cuts_dvcs_CDFT_Inb_3sigma["MM2_epg_lb"], cuts_dvcs_FD_Outb_3sigma["MM2_epg_lb"], cuts_dvcs_CD_Outb_3sigma["MM2_epg_lb"], cuts_dvcs_CDFT_Outb_3sigma["MM2_epg_lb"]))
		print("$ub_{MM^2_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MM2_epg_ub"], cuts_dvcs_CD_Inb_3sigma["MM2_epg_ub"], cuts_dvcs_CDFT_Inb_3sigma["MM2_epg_ub"], cuts_dvcs_FD_Outb_3sigma["MM2_epg_ub"], cuts_dvcs_CD_Outb_3sigma["MM2_epg_ub"], cuts_dvcs_CDFT_Outb_3sigma["MM2_epg_ub"]))
		print("$lb_{ME_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["ME_epg_lb"], cuts_dvcs_CD_Inb_3sigma["ME_epg_lb"], cuts_dvcs_CDFT_Inb_3sigma["ME_epg_lb"], cuts_dvcs_FD_Outb_3sigma["ME_epg_lb"], cuts_dvcs_CD_Outb_3sigma["ME_epg_lb"], cuts_dvcs_CDFT_Outb_3sigma["ME_epg_lb"]))
		print("$ub_{ME_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["ME_epg_ub"], cuts_dvcs_CD_Inb_3sigma["ME_epg_ub"], cuts_dvcs_CDFT_Inb_3sigma["ME_epg_ub"], cuts_dvcs_FD_Outb_3sigma["ME_epg_ub"], cuts_dvcs_CD_Outb_3sigma["ME_epg_ub"], cuts_dvcs_CDFT_Outb_3sigma["ME_epg_ub"]))
		print("$ub_{MPt_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["MPt_ub"], cuts_dvcs_CD_Inb_3sigma["MPt_ub"], cuts_dvcs_CDFT_Inb_3sigma["MPt_ub"], cuts_dvcs_FD_Outb_3sigma["MPt_ub"], cuts_dvcs_CD_Outb_3sigma["MPt_ub"], cuts_dvcs_CDFT_Outb_3sigma["MPt_ub"]))
		...
		print("$a_2"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coneAngle_lb"][0], cuts_dvcs_CD_Inb_3sigma["coneAngle_lb"][0], cuts_dvcs_CDFT_Inb_3sigma["coneAngle_lb"][0], cuts_dvcs_FD_Outb_3sigma["coneAngle_lb"][0], cuts_dvcs_CD_Outb_3sigma["coneAngle_lb"][0], cuts_dvcs_CDFT_Outb_3sigma["coneAngle_lb"][0]))
		print("$a_1"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coneAngle_lb"][1], cuts_dvcs_CD_Inb_3sigma["coneAngle_lb"][1], cuts_dvcs_CDFT_Inb_3sigma["coneAngle_lb"][1], cuts_dvcs_FD_Outb_3sigma["coneAngle_lb"][1], cuts_dvcs_CD_Outb_3sigma["coneAngle_lb"][1], cuts_dvcs_CDFT_Outb_3sigma["coneAngle_lb"][1]))
		print("$a_0"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coneAngle_lb"][2], cuts_dvcs_CD_Inb_3sigma["coneAngle_lb"][2], cuts_dvcs_CDFT_Inb_3sigma["coneAngle_lb"][2], cuts_dvcs_FD_Outb_3sigma["coneAngle_lb"][2], cuts_dvcs_CD_Outb_3sigma["coneAngle_lb"][2], cuts_dvcs_CDFT_Outb_3sigma["coneAngle_lb"][2]))
		print("$b_2"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coneAngle_ub"][0], cuts_dvcs_CD_Inb_3sigma["coneAngle_ub"][0], cuts_dvcs_CDFT_Inb_3sigma["coneAngle_ub"][0], cuts_dvcs_FD_Outb_3sigma["coneAngle_ub"][0], cuts_dvcs_CD_Outb_3sigma["coneAngle_ub"][0], cuts_dvcs_CDFT_Outb_3sigma["coneAngle_ub"][0]))
		print("$b_1"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coneAngle_ub"][1], cuts_dvcs_CD_Inb_3sigma["coneAngle_ub"][1], cuts_dvcs_CDFT_Inb_3sigma["coneAngle_ub"][1], cuts_dvcs_FD_Outb_3sigma["coneAngle_ub"][1], cuts_dvcs_CD_Outb_3sigma["coneAngle_ub"][1], cuts_dvcs_CDFT_Outb_3sigma["coneAngle_ub"][1]))
		print("$b_0"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coneAngle_ub"][2], cuts_dvcs_CD_Inb_3sigma["coneAngle_ub"][2], cuts_dvcs_CDFT_Inb_3sigma["coneAngle_ub"][2], cuts_dvcs_FD_Outb_3sigma["coneAngle_ub"][2], cuts_dvcs_CD_Outb_3sigma["coneAngle_ub"][2], cuts_dvcs_CDFT_Outb_3sigma["coneAngle_ub"][2]))
		print("\n")
		print("\n")
		#DVCS 2sigma
		print("&Inb.&Inb.&Inb.&Outb.&Outb.&Outb. \\\\")
		print("&(FD, FD)&(CD, FD)&(CD, FT)&(FD, FD)&(CD, FD)&(CD, FT)\\\\hline")
		print("$lb_{MM^2_{e'p'}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["MM2_ep_lb"], cuts_dvcs_CD_Inb_2sigma["MM2_ep_lb"], cuts_dvcs_CDFT_Inb_2sigma["MM2_ep_lb"], cuts_dvcs_FD_Outb_2sigma["MM2_ep_lb"], cuts_dvcs_CD_Outb_2sigma["MM2_ep_lb"], cuts_dvcs_CDFT_Outb_2sigma["MM2_ep_lb"]))
		print("$ub_{MM^2_{e'p'}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["MM2_ep_ub"], cuts_dvcs_CD_Inb_2sigma["MM2_ep_ub"], cuts_dvcs_CDFT_Inb_2sigma["MM2_ep_ub"], cuts_dvcs_FD_Outb_2sigma["MM2_ep_ub"], cuts_dvcs_CD_Outb_2sigma["MM2_ep_ub"], cuts_dvcs_CDFT_Outb_2sigma["MM2_ep_ub"]))
		print("$lb_{MM^2_{e'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["MM2_eg_lb"], cuts_dvcs_CD_Inb_2sigma["MM2_eg_lb"], cuts_dvcs_CDFT_Inb_2sigma["MM2_eg_lb"], cuts_dvcs_FD_Outb_2sigma["MM2_eg_lb"], cuts_dvcs_CD_Outb_2sigma["MM2_eg_lb"], cuts_dvcs_CDFT_Outb_2sigma["MM2_eg_lb"]))
		print("$ub_{MM^2_{e'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["MM2_eg_ub"], cuts_dvcs_CD_Inb_2sigma["MM2_eg_ub"], cuts_dvcs_CDFT_Inb_2sigma["MM2_eg_ub"], cuts_dvcs_FD_Outb_2sigma["MM2_eg_ub"], cuts_dvcs_CD_Outb_2sigma["MM2_eg_ub"], cuts_dvcs_CDFT_Outb_2sigma["MM2_eg_ub"]))
		print("$lb_{MM^2_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["MM2_epg_lb"], cuts_dvcs_CD_Inb_2sigma["MM2_epg_lb"], cuts_dvcs_CDFT_Inb_2sigma["MM2_epg_lb"], cuts_dvcs_FD_Outb_2sigma["MM2_epg_lb"], cuts_dvcs_CD_Outb_2sigma["MM2_epg_lb"], cuts_dvcs_CDFT_Outb_2sigma["MM2_epg_lb"]))
		print("$ub_{MM^2_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["MM2_epg_ub"], cuts_dvcs_CD_Inb_2sigma["MM2_epg_ub"], cuts_dvcs_CDFT_Inb_2sigma["MM2_epg_ub"], cuts_dvcs_FD_Outb_2sigma["MM2_epg_ub"], cuts_dvcs_CD_Outb_2sigma["MM2_epg_ub"], cuts_dvcs_CDFT_Outb_2sigma["MM2_epg_ub"]))
		print("$lb_{ME_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["ME_epg_lb"], cuts_dvcs_CD_Inb_2sigma["ME_epg_lb"], cuts_dvcs_CDFT_Inb_2sigma["ME_epg_lb"], cuts_dvcs_FD_Outb_2sigma["ME_epg_lb"], cuts_dvcs_CD_Outb_2sigma["ME_epg_lb"], cuts_dvcs_CDFT_Outb_2sigma["ME_epg_lb"]))
		print("$ub_{ME_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["ME_epg_ub"], cuts_dvcs_CD_Inb_2sigma["ME_epg_ub"], cuts_dvcs_CDFT_Inb_2sigma["ME_epg_ub"], cuts_dvcs_FD_Outb_2sigma["ME_epg_ub"], cuts_dvcs_CD_Outb_2sigma["ME_epg_ub"], cuts_dvcs_CDFT_Outb_2sigma["ME_epg_ub"]))
		...
		print("$a_2"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coneAngle_lb"][0], cuts_dvcs_CD_Inb_2sigma["coneAngle_lb"][0], cuts_dvcs_CDFT_Inb_2sigma["coneAngle_lb"][0], cuts_dvcs_FD_Outb_2sigma["coneAngle_lb"][0], cuts_dvcs_CD_Outb_2sigma["coneAngle_lb"][0], cuts_dvcs_CDFT_Outb_2sigma["coneAngle_lb"][0]))
		print("$a_1"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coneAngle_lb"][1], cuts_dvcs_CD_Inb_2sigma["coneAngle_lb"][1], cuts_dvcs_CDFT_Inb_2sigma["coneAngle_lb"][1], cuts_dvcs_FD_Outb_2sigma["coneAngle_lb"][1], cuts_dvcs_CD_Outb_2sigma["coneAngle_lb"][1], cuts_dvcs_CDFT_Outb_2sigma["coneAngle_lb"][1]))
		print("$a_0"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coneAngle_lb"][2], cuts_dvcs_CD_Inb_2sigma["coneAngle_lb"][2], cuts_dvcs_CDFT_Inb_2sigma["coneAngle_lb"][2], cuts_dvcs_FD_Outb_2sigma["coneAngle_lb"][2], cuts_dvcs_CD_Outb_2sigma["coneAngle_lb"][2], cuts_dvcs_CDFT_Outb_2sigma["coneAngle_lb"][2]))
		print("$b_2"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coneAngle_ub"][0], cuts_dvcs_CD_Inb_2sigma["coneAngle_ub"][0], cuts_dvcs_CDFT_Inb_2sigma["coneAngle_ub"][0], cuts_dvcs_FD_Outb_2sigma["coneAngle_ub"][0], cuts_dvcs_CD_Outb_2sigma["coneAngle_ub"][0], cuts_dvcs_CDFT_Outb_2sigma["coneAngle_ub"][0]))
		print("$b_1"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coneAngle_ub"][1], cuts_dvcs_CD_Inb_2sigma["coneAngle_ub"][1], cuts_dvcs_CDFT_Inb_2sigma["coneAngle_ub"][1], cuts_dvcs_FD_Outb_2sigma["coneAngle_ub"][1], cuts_dvcs_CD_Outb_2sigma["coneAngle_ub"][1], cuts_dvcs_CDFT_Outb_2sigma["coneAngle_ub"][1]))
		print("$b_0"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coneAngle_ub"][2], cuts_dvcs_CD_Inb_2sigma["coneAngle_ub"][2], cuts_dvcs_CDFT_Inb_2sigma["coneAngle_ub"][2], cuts_dvcs_FD_Outb_2sigma["coneAngle_ub"][2], cuts_dvcs_CD_Outb_2sigma["coneAngle_ub"][2], cuts_dvcs_CDFT_Outb_2sigma["coneAngle_ub"][2]))
		print("\n")
		print("\n")
		...
		print("&Inb.&Inb.&Inb.&Outb.&Outb.&Outb. \\\\")
		print("&(FD, FD)&(CD, FD)&(CD, FT)&(FD, FD)&(CD, FD)&(CD, FT)\\\\hline")
		print("$lb_{MM^2_{e'p'}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["MM2_ep_lb"], cuts_dvcs_CD_Inb_4sigma["MM2_ep_lb"], cuts_dvcs_CDFT_Inb_4sigma["MM2_ep_lb"], cuts_dvcs_FD_Outb_4sigma["MM2_ep_lb"], cuts_dvcs_CD_Outb_4sigma["MM2_ep_lb"], cuts_dvcs_CDFT_Outb_4sigma["MM2_ep_lb"]))
		print("$ub_{MM^2_{e'p'}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["MM2_ep_ub"], cuts_dvcs_CD_Inb_4sigma["MM2_ep_ub"], cuts_dvcs_CDFT_Inb_4sigma["MM2_ep_ub"], cuts_dvcs_FD_Outb_4sigma["MM2_ep_ub"], cuts_dvcs_CD_Outb_4sigma["MM2_ep_ub"], cuts_dvcs_CDFT_Outb_4sigma["MM2_ep_ub"]))
		print("$lb_{MM^2_{e'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["MM2_eg_lb"], cuts_dvcs_CD_Inb_4sigma["MM2_eg_lb"], cuts_dvcs_CDFT_Inb_4sigma["MM2_eg_lb"], cuts_dvcs_FD_Outb_4sigma["MM2_eg_lb"], cuts_dvcs_CD_Outb_4sigma["MM2_eg_lb"], cuts_dvcs_CDFT_Outb_4sigma["MM2_eg_lb"]))
		print("$ub_{MM^2_{e'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["MM2_eg_ub"], cuts_dvcs_CD_Inb_4sigma["MM2_eg_ub"], cuts_dvcs_CDFT_Inb_4sigma["MM2_eg_ub"], cuts_dvcs_FD_Outb_4sigma["MM2_eg_ub"], cuts_dvcs_CD_Outb_4sigma["MM2_eg_ub"], cuts_dvcs_CDFT_Outb_4sigma["MM2_eg_ub"]))
		print("$lb_{MM^2_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["MM2_epg_lb"], cuts_dvcs_CD_Inb_4sigma["MM2_epg_lb"], cuts_dvcs_CDFT_Inb_4sigma["MM2_epg_lb"], cuts_dvcs_FD_Outb_4sigma["MM2_epg_lb"], cuts_dvcs_CD_Outb_4sigma["MM2_epg_lb"], cuts_dvcs_CDFT_Outb_4sigma["MM2_epg_lb"]))
		print("$ub_{MM^2_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["MM2_epg_ub"], cuts_dvcs_CD_Inb_4sigma["MM2_epg_ub"], cuts_dvcs_CDFT_Inb_4sigma["MM2_epg_ub"], cuts_dvcs_FD_Outb_4sigma["MM2_epg_ub"], cuts_dvcs_CD_Outb_4sigma["MM2_epg_ub"], cuts_dvcs_CDFT_Outb_4sigma["MM2_epg_ub"]))
		print("$lb_{ME_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["ME_epg_lb"], cuts_dvcs_CD_Inb_4sigma["ME_epg_lb"], cuts_dvcs_CDFT_Inb_4sigma["ME_epg_lb"], cuts_dvcs_FD_Outb_4sigma["ME_epg_lb"], cuts_dvcs_CD_Outb_4sigma["ME_epg_lb"], cuts_dvcs_CDFT_Outb_4sigma["ME_epg_lb"]))
		print("$ub_{ME_{e'p'\gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["ME_epg_ub"], cuts_dvcs_CD_Inb_4sigma["ME_epg_ub"], cuts_dvcs_CDFT_Inb_4sigma["ME_epg_ub"], cuts_dvcs_FD_Outb_4sigma["ME_epg_ub"], cuts_dvcs_CD_Outb_4sigma["ME_epg_ub"], cuts_dvcs_CDFT_Outb_4sigma["ME_epg_ub"]))
		...
		print("$a_2"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coneAngle_lb"][0], cuts_dvcs_CD_Inb_4sigma["coneAngle_lb"][0], cuts_dvcs_CDFT_Inb_4sigma["coneAngle_lb"][0], cuts_dvcs_FD_Outb_4sigma["coneAngle_lb"][0], cuts_dvcs_CD_Outb_4sigma["coneAngle_lb"][0], cuts_dvcs_CDFT_Outb_4sigma["coneAngle_lb"][0]))
		print("$a_1"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coneAngle_lb"][1], cuts_dvcs_CD_Inb_4sigma["coneAngle_lb"][1], cuts_dvcs_CDFT_Inb_4sigma["coneAngle_lb"][1], cuts_dvcs_FD_Outb_4sigma["coneAngle_lb"][1], cuts_dvcs_CD_Outb_4sigma["coneAngle_lb"][1], cuts_dvcs_CDFT_Outb_4sigma["coneAngle_lb"][1]))
		print("$a_0"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coneAngle_lb"][2], cuts_dvcs_CD_Inb_4sigma["coneAngle_lb"][2], cuts_dvcs_CDFT_Inb_4sigma["coneAngle_lb"][2], cuts_dvcs_FD_Outb_4sigma["coneAngle_lb"][2], cuts_dvcs_CD_Outb_4sigma["coneAngle_lb"][2], cuts_dvcs_CDFT_Outb_4sigma["coneAngle_lb"][2]))
		print("$b_2"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coneAngle_ub"][0], cuts_dvcs_CD_Inb_4sigma["coneAngle_ub"][0], cuts_dvcs_CDFT_Inb_4sigma["coneAngle_ub"][0], cuts_dvcs_FD_Outb_4sigma["coneAngle_ub"][0], cuts_dvcs_CD_Outb_4sigma["coneAngle_ub"][0], cuts_dvcs_CDFT_Outb_4sigma["coneAngle_ub"][0]))
		print("$b_1"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coneAngle_ub"][1], cuts_dvcs_CD_Inb_4sigma["coneAngle_ub"][1], cuts_dvcs_CDFT_Inb_4sigma["coneAngle_ub"][1], cuts_dvcs_FD_Outb_4sigma["coneAngle_ub"][1], cuts_dvcs_CD_Outb_4sigma["coneAngle_ub"][1], cuts_dvcs_CDFT_Outb_4sigma["coneAngle_ub"][1]))
		print("$b_0"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coneAngle_ub"][2], cuts_dvcs_CD_Inb_4sigma["coneAngle_ub"][2], cuts_dvcs_CDFT_Inb_4sigma["coneAngle_ub"][2], cuts_dvcs_FD_Outb_4sigma["coneAngle_ub"][2], cuts_dvcs_CD_Outb_4sigma["coneAngle_ub"][2], cuts_dvcs_CDFT_Outb_4sigma["coneAngle_ub"][2]))
		print("\n")
		print("\n")
		...
		# print("&Inb.&Inb.&Inb.&Outb.&Outb.&Outb. \\")
		# print("&(FD, FD)&(CD, FD)&(CD, FT)&(FD, FD)&(CD, FD)&(CD, FT)\\\hline")
		# print("$lb_{IM_{\pi^0}}$&{}&{}&{}&{}&{}\\".format())
		# print("$ub_{IM_{\pi^0}}$&{}&{}&{}&{}&{}\\".format())
		# print("$lb_{MM^2_{e'p'}}$&{}&{}&{}&{}&{}\\".format())
		# print("$ub_{MM^2_{e'p'}}$&{}&{}&{}&{}&{}\\".format())
		# print("$lb_{MM^2_{e'\pi}}$&{}&{}&{}&{}&{}\\".format())
		# print("$ub_{MM^2_{e'\pi}}$&{}&{}&{}&{}&{}\\".format())
		# print("$lb_{MM^2_{e'p'\pi}}$&{}&{}&{}&{}&{}\\".format())
		# print("$ub_{MM^2_{e'p'\pi}}$&{}&{}&{}&{}&{}\\".format())
		# print("$lb_{ME_{e'p'\pi}}$&{}&{}&{}&{}&{}\\".format())
		# print("$ub_{ME_{e'p'\pi}}$&{}&{}&{}&{}&{}\\".format())
	...
	if args.figureofmerit == "PID":
		...
		InbExp_effect_Epcal = sum(InbExp.loc[:, "EFid_pcal"])/len(InbExp.loc[:, "EFid_pcal"])
		InbExp_effect_Edw = sum(InbExp.loc[:, "EFid_dw"])/len(InbExp.loc[:, "EFid_dw"])
		InbExp_effect_Edc = sum(InbExp.loc[:, "EFid_dc"])/len(InbExp.loc[:, "EFid_dc"])
		InbExp_effect_Esf = sum(InbExp.loc[:, "EFid_sf"])/len(InbExp.loc[:, "EFid_sf"])
		InbExp_effect_Evz = sum(InbExp.loc[:, "EFid_vz"])/len(InbExp.loc[:, "EFid_vz"])
		InbExp_effect_Eedep = sum(InbExp.loc[:, "EFid_edep"])/len(InbExp.loc[:, "EFid_edep"])
		InbExp_effect_Eap = sum(InbExp.loc[:, "EFid_ap"])/len(InbExp.loc[:, "EFid_ap"])
		InbExp_effect_Pdc = sum(InbExp.loc[InbExp.Psector < 7, "PFid_dc"])/len(InbExp.loc[InbExp.Psector < 7, "PFid_dc"])
		InbExp_effect_Pcvt = sum(InbExp.loc[InbExp.Psector > 7, "PFid_cvt"])/len(InbExp.loc[InbExp.Psector > 7, "PFid_cvt"])
		InbExp_effect_Pchi = sum(InbExp.loc[:, "PFid_chi"])/len(InbExp.loc[:, "PFid_chi"])
		InbExp_effect_Pvz = sum(InbExp.loc[:, "PFid_vz"])/len(InbExp.loc[:, "PFid_vz"])
		InbExp_effect_Gbeta = sum(InbExp.loc[:, "GFid_beta"])/len(InbExp.loc[:, "GFid_beta"])
		InbExp_effect_Gpcal1 = sum(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal1"])/len(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal1"])
		InbExp_effect_Gpcal2 = sum(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal2"])/len(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal2"])
		InbExp_effect_Gft = sum(InbExp.loc[InbExp.Psector < 7, "GFid_FT"])/len(InbExp.loc[InbExp.Psector < 7, "GFid_FT"])

		InbSim_effect_Epcal = sum(InbSim.loc[:, "EFid_pcal"])/len(InbSim.loc[:, "EFid_pcal"])
		InbSim_effect_Edw = sum(InbSim.loc[:, "EFid_dw"])/len(InbSim.loc[:, "EFid_dw"])
		InbSim_effect_Edc = sum(InbSim.loc[:, "EFid_dc"])/len(InbSim.loc[:, "EFid_dc"])
		InbSim_effect_Esf = sum(InbSim.loc[:, "EFid_sf"])/len(InbSim.loc[:, "EFid_sf"])
		InbSim_effect_Evz = sum(InbSim.loc[:, "EFid_vz"])/len(InbSim.loc[:, "EFid_vz"])
		InbSim_effect_Eedep = sum(InbSim.loc[:, "EFid_edep"])/len(InbSim.loc[:, "EFid_edep"])
		InbSim_effect_Eap = sum(InbSim.loc[:, "EFid_ap"])/len(InbSim.loc[:, "EFid_ap"])
		InbSim_effect_Pdc = sum(InbSim.loc[InbSim.Psector < 7, "PFid_dc"])/len(InbSim.loc[InbSim.Psector < 7, "PFid_dc"])
		InbSim_effect_Pcvt = sum(InbSim.loc[InbSim.Psector > 7, "PFid_cvt"])/len(InbSim.loc[InbSim.Psector > 7, "PFid_cvt"])
		InbSim_effect_Pchi = sum(InbSim.loc[:, "PFid_chi"])/len(InbSim.loc[:, "PFid_chi"])
		InbSim_effect_Pvz = sum(InbSim.loc[:, "PFid_vz"])/len(InbSim.loc[:, "PFid_vz"])
		InbSim_effect_Gbeta = sum(InbSim.loc[:, "GFid_beta"])/len(InbSim.loc[:, "GFid_beta"])
		InbSim_effect_Gpcal1 = sum(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal1"])/len(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal1"])
		InbSim_effect_Gpcal2 = sum(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal2"])/len(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal2"])
		InbSim_effect_Gft = sum(InbSim.loc[InbSim.Psector < 7, "GFid_FT"])/len(InbSim.loc[InbSim.Psector < 7, "GFid_FT"])

		OutbExp_effect_Epcal = sum(OutbExp.loc[:, "EFid_pcal"])/len(OutbExp.loc[:, "EFid_pcal"])
		OutbExp_effect_Edw = sum(OutbExp.loc[:, "EFid_dw"])/len(OutbExp.loc[:, "EFid_dw"])
		OutbExp_effect_Edc = sum(OutbExp.loc[:, "EFid_dc"])/len(OutbExp.loc[:, "EFid_dc"])
		OutbExp_effect_Esf = sum(OutbExp.loc[:, "EFid_sf"])/len(OutbExp.loc[:, "EFid_sf"])
		OutbExp_effect_Evz = sum(OutbExp.loc[:, "EFid_vz"])/len(OutbExp.loc[:, "EFid_vz"])
		OutbExp_effect_Eedep = sum(OutbExp.loc[:, "EFid_edep"])/len(OutbExp.loc[:, "EFid_edep"])
		OutbExp_effect_Eap = sum(OutbExp.loc[:, "EFid_ap"])/len(OutbExp.loc[:, "EFid_ap"])
		OutbExp_effect_Pdc = sum(OutbExp.loc[OutbExp.Psector < 7, "PFid_dc"])/len(OutbExp.loc[OutbExp.Psector < 7, "PFid_dc"])
		OutbExp_effect_Pcvt = sum(OutbExp.loc[OutbExp.Psector > 7, "PFid_cvt"])/len(OutbExp.loc[OutbExp.Psector > 7, "PFid_cvt"])
		OutbExp_effect_Pchi = sum(OutbExp.loc[:, "PFid_chi"])/len(OutbExp.loc[:, "PFid_chi"])
		OutbExp_effect_Pvz = sum(OutbExp.loc[:, "PFid_vz"])/len(OutbExp.loc[:, "PFid_vz"])
		OutbExp_effect_Gbeta = sum(OutbExp.loc[:, "GFid_beta"])/len(OutbExp.loc[:, "GFid_beta"])
		OutbExp_effect_Gpcal1 = sum(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal1"])/len(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal1"])
		OutbExp_effect_Gpcal2 = sum(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal2"])/len(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal2"])
		OutbExp_effect_Gft = sum(OutbExp.loc[OutbExp.Psector < 7, "GFid_FT"])/len(OutbExp.loc[OutbExp.Psector < 7, "GFid_FT"])

		OutbSim_effect_Epcal = sum(OutbSim.loc[:, "EFid_pcal"])/len(OutbSim.loc[:, "EFid_pcal"])
		OutbSim_effect_Edw = sum(OutbSim.loc[:, "EFid_dw"])/len(OutbSim.loc[:, "EFid_dw"])
		OutbSim_effect_Edc = sum(OutbSim.loc[:, "EFid_dc"])/len(OutbSim.loc[:, "EFid_dc"])
		OutbSim_effect_Esf = sum(OutbSim.loc[:, "EFid_sf"])/len(OutbSim.loc[:, "EFid_sf"])
		OutbSim_effect_Evz = sum(OutbSim.loc[:, "EFid_vz"])/len(OutbSim.loc[:, "EFid_vz"])
		OutbSim_effect_Eedep = sum(OutbSim.loc[:, "EFid_edep"])/len(OutbSim.loc[:, "EFid_edep"])
		OutbSim_effect_Eap = sum(OutbSim.loc[:, "EFid_ap"])/len(OutbSim.loc[:, "EFid_ap"])
		OutbSim_effect_Pdc = sum(OutbSim.loc[OutbSim.Psector < 7, "PFid_dc"])/len(OutbSim.loc[OutbSim.Psector < 7, "PFid_dc"])
		OutbSim_effect_Pcvt = sum(OutbSim.loc[OutbSim.Psector > 7, "PFid_cvt"])/len(OutbSim.loc[OutbSim.Psector > 7, "PFid_cvt"])
		OutbSim_effect_Pchi = sum(OutbSim.loc[:, "PFid_chi"])/len(OutbSim.loc[:, "PFid_chi"])
		OutbSim_effect_Pvz = sum(OutbSim.loc[:, "PFid_vz"])/len(OutbSim.loc[:, "PFid_vz"])
		OutbSim_effect_Gbeta = sum(OutbSim.loc[:, "GFid_beta"])/len(OutbSim.loc[:, "GFid_beta"])
		OutbSim_effect_Gpcal1 = sum(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal1"])/len(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal1"])
		OutbSim_effect_Gpcal2 = sum(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal2"])/len(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal2"])
		OutbSim_effect_Gft = sum(OutbSim.loc[OutbSim.Psector < 7, "GFid_FT"])/len(OutbSim.loc[OutbSim.Psector < 7, "GFid_FT"])

		print("&Exp. Inb.&Sim. Inb. & Exp.:Sim. Inb. &Exp. Outb.&Sim. Outb. & Exp.:Sim. Outb. \\\\hline")
		print("$e'$ PCAL1 &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Epcal, 100*InbSim_effect_Epcal, 100*InbExp_effect_Epcal/InbSim_effect_Epcal, 100*OutbExp_effect_Epcal, 100*OutbSim_effect_Epcal, 100*OutbExp_effect_Epcal/OutbSim_effect_Epcal))
		print("$e'$ PCAL2 &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Edw, 100*InbSim_effect_Edw, 100*InbExp_effect_Edw/InbSim_effect_Edw, 100*OutbExp_effect_Edw, 100*OutbSim_effect_Edw, 100*OutbExp_effect_Edw/OutbSim_effect_Edw))
		print("$e'$ DC &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Edc, 100*InbSim_effect_Edc, 100*InbExp_effect_Edc/InbSim_effect_Edc, 100*OutbExp_effect_Edc, 100*OutbSim_effect_Edc, 100*OutbExp_effect_Edc/OutbSim_effect_Edc))
		print("$e'$ SF &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Esf, 100*InbSim_effect_Esf, 100*InbExp_effect_Esf/InbSim_effect_Esf, 100*OutbExp_effect_Esf, 100*OutbSim_effect_Esf, 100*OutbExp_effect_Esf/OutbSim_effect_Esf))
		print("$e'$ $vz$ &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Evz, 100*InbSim_effect_Evz, 100*InbExp_effect_Evz/InbSim_effect_Evz, 100*OutbExp_effect_Evz, 100*OutbSim_effect_Evz, 100*OutbExp_effect_Evz/OutbSim_effect_Evz))
		print("$e'$ $E_{dep.}$" + " &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Eedep, 100*InbSim_effect_Eedep, 100*InbExp_effect_Eedep/InbSim_effect_Eedep, 100*OutbExp_effect_Eedep, 100*OutbSim_effect_Eedep, 100*OutbExp_effect_Eedep/OutbSim_effect_Eedep))
		...
		print("$p'$ DC &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pdc, 100*InbSim_effect_Pdc, 100*InbExp_effect_Pdc/InbSim_effect_Pdc, 100*OutbExp_effect_Pdc, 100*OutbSim_effect_Pdc, 100*OutbExp_effect_Pdc/OutbSim_effect_Pdc))
		print("$p'$ CVT &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pcvt, 100*InbSim_effect_Pcvt, 100*InbExp_effect_Pcvt/InbSim_effect_Pcvt, 100*OutbExp_effect_Pcvt, 100*OutbSim_effect_Pcvt, 100*OutbExp_effect_Pcvt/OutbSim_effect_Pcvt))
		print("$p'$ $\chi$ &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pchi, 100*InbSim_effect_Pchi, 100*InbExp_effect_Pchi/InbSim_effect_Pchi, 100*OutbExp_effect_Pchi, 100*OutbSim_effect_Pchi, 100*OutbExp_effect_Pchi/OutbSim_effect_Pchi))
		...
		print("$\gamma$ $\beta$ &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gbeta, 100*InbSim_effect_Gbeta, 100*InbExp_effect_Gbeta/InbSim_effect_Gbeta, 100*OutbExp_effect_Gbeta, 100*OutbSim_effect_Gbeta, 100*OutbExp_effect_Gbeta/OutbSim_effect_Gbeta))
		print("$\gamma$ PCAL1 &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gpcal1, 100*InbSim_effect_Gpcal1, 100*InbExp_effect_Gpcal1/InbSim_effect_Gpcal1, 100*OutbExp_effect_Gpcal1, 100*OutbSim_effect_Gpcal1, 100*OutbExp_effect_Gpcal1/OutbSim_effect_Gpcal2))
		print("$\gamma$ PCAL2 &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gpcal2, 100*InbSim_effect_Gpcal2, 100*InbExp_effect_Gpcal2/InbSim_effect_Gpcal2, 100*OutbExp_effect_Gpcal2, 100*OutbSim_effect_Gpcal2, 100*OutbExp_effect_Gpcal2/OutbSim_effect_Gpcal2))
	...
	if args.figureofmerit == "proton":
		...
		expSample = pd.read_pickle("/volatile/clas12/sangbaek/nov2021/convPkl_full_nofid_Corr/inb/exp/dvcs.pkl")
		...
		axs.set_ylim([0, 0.06])
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd.pdf")
		plt.clf()
		...
		axs.set_ylim([0, 0.06])
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd_cvt.pdf")
		plt.clf()
		...
		axs.set_title("(a)", loc = 'left')
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd2.pdf")
		plt.clf()
		...
		axs.set_title("(b)", loc = 'left')
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd3.pdf")
		plt.clf()
		...
		axs.set_ylim([0.75, 2.5])
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd4.pdf")
		plt.clf()
		...
		axs.set_title("(b)", loc = 'left')
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd5.pdf")
		plt.clf()
		...
		axs.set_title("(a)", loc = 'left')
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd6.pdf")
		plt.clf()
		...
		axs.set_title("(b)", loc = 'left')
		plt.tight_layout()
		plt.savefig("plots/ch5/precut_pfid_cd7.pdf")
		plt.clf()
		exit()
