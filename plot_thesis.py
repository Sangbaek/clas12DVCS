...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		InbExp_effect_Gpcal1 = sum(InbExp.loc[InbExp.Gsector < 7, "GFid_Pcal1"])/len(InbExp.loc[InbExp.Gsector < 7, "GFid_Pcal1"])
		InbExp_effect_Gpcal2 = sum(InbExp.loc[InbExp.Gsector < 7, "GFid_Pcal2"])/len(InbExp.loc[InbExp.Gsector < 7, "GFid_Pcal2"])
		InbExp_effect_Gft = sum(InbExp.loc[InbExp.Gsector > 7, "GFid_FT"])/len(InbExp.loc[InbExp.Gsector > 7, "GFid_FT"])
		...
		InbSim_effect_Gpcal1 = sum(InbSim.loc[InbSim.Gsector < 7, "GFid_Pcal1"])/len(InbSim.loc[InbSim.Gsector < 7, "GFid_Pcal1"])
		InbSim_effect_Gpcal2 = sum(InbSim.loc[InbSim.Gsector < 7, "GFid_Pcal2"])/len(InbSim.loc[InbSim.Gsector < 7, "GFid_Pcal2"])
		InbSim_effect_Gft = sum(InbSim.loc[InbSim.Gsector > 7, "GFid_FT"])/len(InbSim.loc[InbSim.Gsector > 7, "GFid_FT"])
		...
		OutbExp_effect_Gpcal1 = sum(OutbExp.loc[OutbExp.Gsector < 7, "GFid_Pcal1"])/len(OutbExp.loc[OutbExp.Gsector < 7, "GFid_Pcal1"])
		OutbExp_effect_Gpcal2 = sum(OutbExp.loc[OutbExp.Gsector < 7, "GFid_Pcal2"])/len(OutbExp.loc[OutbExp.Gsector < 7, "GFid_Pcal2"])
		OutbExp_effect_Gft = sum(OutbExp.loc[OutbExp.Gsector > 7, "GFid_FT"])/len(OutbExp.loc[OutbExp.Gsector > 7, "GFid_FT"])
		...
		OutbSim_effect_Gpcal1 = sum(OutbSim.loc[OutbSim.Gsector < 7, "GFid_Pcal1"])/len(OutbSim.loc[OutbSim.Gsector < 7, "GFid_Pcal1"])
		OutbSim_effect_Gpcal2 = sum(OutbSim.loc[OutbSim.Gsector < 7, "GFid_Pcal2"])/len(OutbSim.loc[OutbSim.Gsector < 7, "GFid_Pcal2"])
		OutbSim_effect_Gft = sum(OutbSim.loc[OutbSim.Gsector > 7, "GFid_FT"])/len(OutbSim.loc[OutbSim.Gsector > 7, "GFid_FT"])
