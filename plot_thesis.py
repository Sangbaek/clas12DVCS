...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		print("$e'$ PCAL1 &{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%\\\\".format(100*InbExp_effect_Epcal, 100*InbSim_effect_Epcal, 100*InbExp_effect_Epcal/InbSim_effect_Epcal, 100*OutbExp_effect_Epcal, 100*OutbSim_effect_Epcal, 100*OutbExp_effect_Epcal/OutbSim_effect_Epcal))
		print("$e'$ PCAL2 &{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%&{:.1f}\%\\\\".format(100*InbExp_effect_Edw, 100*InbSim_effect_Edw, 100*InbExp_effect_Edw/InbSim_effect_Edw, 100*OutbExp_effect_Edw, 100*OutbSim_effect_Edw, 100*OutbExp_effect_Edw/OutbSim_effect_Edw))
