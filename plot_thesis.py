...
if chapter == 2:
	...
	if polarity == "inbending":
		...
		plt.legend(loc='lower left', bbox_to_anchor = (0.9, 0.6), framealpha = 0.5)
		plt.xlabel(r"$\theta_{\mathrm{CVT}}$" + " ["+degree+"]")
		axs.set_title("(a)", loc = 'left')
		axs.set_xlim([40, 90])
		axs.set_xticks([40, 44.5, 50, 60, 70])
		axs.set_xticklabels([40, "", 50, 60, 70])
...
if chapter == 4:
	...
	if args.figureofmerit == "electron":
		...
		inb_FD.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'r', ax = axs[0])
		inb_FD_corr.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'b', ax = axs[0])
		axs[0].set_title("Inb. FD  " + r"$MM^2_{e'p'}$")
		axs[0].set_ylim([0, 5])
		axs[0].set_yticks([0, 1, 2, 3, 4, 5])
		axs[0].set_yticklabels(['', r'$1$', r'$2$', r'$3$', r'$4$', r'$5$'])
		# axs[0].set_yticklabels(['',two+times+tenthousands, four+times+tenthousands, six+times+tenthousands])

		outb_FD.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'r', ax = axs[1])
		outb_FD_corr.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'b', ax = axs[1])
		axs[1].set_title("Outb. FD  " + r"$MM^2_{e'p'}$")
		axs[1].set_ylim([0, 5])
		axs[1].set_yticks([0, 1, 2, 3, 4, 5])
		axs[1].set_yticklabels(['', r'$1$', r'$2$', r'$3$', r'$4$', r'$5$'])
		...
		inb_CD.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'r', ax = axs[2])
		inb_CD_corr.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'b', ax = axs[2])
		axs[2].set_title("Inb. CD  " + r"$MM^2_{e'p'}$")
		axs[2].set_ylim([0, 5])
		axs[2].set_yticks([0, 1, 2, 3, 4, 5])
		axs[2].set_yticklabels(['', r'$1$', r'$2$', r'$3$', r'$4$', r'$5$'])
		...
		outb_CD.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'r', ax = axs[3])
		outb_CD_corr.MM2_ep.hist(bins = bins, histtype = 'step', density = True, edgecolor = 'b', ax = axs[3])
		axs[3].set_title("Outb. CD  " + r"$MM^2_{e'p'}$")
		axs[3].set_ylim([0, 5])
		axs[3].set_yticks([0, 1, 2, 3, 4, 5])
		axs[3].set_yticklabels(['', r'$1$', r'$2$', r'$3$', r'$4$', r'$5$'])
		...
		(inb_FD.GenPp - inb_FD.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'r', ax = axs[0])
		(inb_FD_corr.GenPp - inb_FD_corr.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'b', ax = axs[0])
		axs[0].set_title("Inb. FD  " + r"$\delta p$")
		axs[0].set_ylim([0, 60])
		axs[0].set_yticks([0, 10, 20, 30, 40, 50, 60])
		axs[0].set_yticklabels(['', r'$10$', r'$20$', r'$30$', r'$40$', r'$50$', r'$60$'])
		...
		(outb_FD.GenPp - outb_FD.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'r', ax = axs[1])
		(outb_FD_corr.GenPp - outb_FD_corr.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'b', ax = axs[1])
		axs[1].set_title("Outb. FD  " + r"$\delta p$")
		axs[1].set_ylim([0, 50])
		axs[1].set_yticks([0, 10, 20, 30, 40, 50])
		axs[1].set_yticklabels(['', r'$10$', r'$20$', r'$30$', r'$40$', r'$50$'])
		...
		(inb_CD.GenPp - inb_CD.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'r', ax = axs[2])
		(inb_CD_corr.GenPp - inb_CD_corr.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'b', ax = axs[2])
		axs[2].set_title("Inb. CD  " + r"$\delta p$")
		axs[2].set_ylim([0, 25])
		axs[2].set_yticks([0, 5, 10, 15, 20, 25])
		axs[2].set_yticklabels(['', r'$5$', r'$10$', r'$15$', r'$20$', r'$25$'])
		...
		(outb_CD.GenPp - outb_CD.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'r', ax = axs[3])
		(outb_CD_corr.GenPp - outb_CD_corr.Pp).hist(bins = bins_p, histtype = 'step', density = True, edgecolor = 'b', ax = axs[3])
		axs[3].set_title("Outb. CD  " + r"$\delta p$")
		axs[3].set_ylim([0, 25])
		axs[3].set_yticks([0, 5, 10, 15, 20, 25])
		axs[3].set_yticklabels(['', r'$5$', r'$10$', r'$15$', r'$20$', r'$25$'])
		...
		(inb_FD.GenPtheta - inb_FD.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'r', ax = axs[0])
		(inb_FD_corr.GenPtheta - inb_FD_corr.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'b', ax = axs[0])
		axs[0].set_title("Inb. FD  " + r"$\delta \theta$")
		axs[0].set_ylim([0, .8])
		axs[0].set_yticks([0, .2, .4, .6, .8])
		axs[0].set_yticklabels(['', r'$0.2$', r'$0.4$', r'$0.6$', r'$0.8$'])
		...
		(outb_FD.GenPtheta - outb_FD.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'r', ax = axs[1])
		(outb_FD_corr.GenPtheta - outb_FD_corr.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'b', ax = axs[1])
		axs[1].set_title("Outb. FD  " + r"$\delta \theta$")
		axs[1].set_ylim([0, 1])
		axs[1].set_yticks([0, .2, .4, .6, .8, 1])
		axs[1].set_yticklabels(['', r'$0.2$', r'$0.4$', r'$0.6$', r'$0.8$', r'$1$'])
		# axs[1].set_ylim([0, 20000])
		# axs[1].set_yticks([0, 5000, 10000, 15000, 20000])
		# axs[1].set_yticklabels(['',five+times+thousand, tenthousands, one+point+five+times+tenthousands, two +times+tenthousands])

		(inb_CD.GenPtheta - inb_CD.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'r', ax = axs[2])
		(inb_CD_corr.GenPtheta - inb_CD_corr.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'b', ax = axs[2])
		axs[2].set_title("Inb. CD  " + r"$\delta \theta$")
		axs[2].set_ylim([0, .8])
		axs[2].set_yticks([0, .2, .4, .6, .8])
		axs[2].set_yticklabels(['', r'$0.2$', r'$0.4$', r'$0.6$', r'$0.8$'])
		...
		(outb_CD.GenPtheta - outb_CD.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'r', ax = axs[3])
		(outb_CD_corr.GenPtheta - outb_CD_corr.Ptheta).hist(bins = bins_theta, histtype = 'step', density = True, edgecolor = 'b', ax = axs[3])
		axs[3].set_title("Outb. CD  " + r"$\delta \theta$")
		axs[3].set_ylim([0, .8])
		axs[3].set_yticks([0, .2, .4, .6, .8])
		axs[3].set_yticklabels(['', r'$0.2$', r'$0.4$', r'$0.6$', r'$0.8$'])
		...
		(inb_FD.GenPphi - inb_FD.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'r', ax = axs[0])
		(inb_FD_corr.GenPphi - inb_FD_corr.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'b', ax = axs[0])
		axs[0].set_title("Inb. FD  " + r"$\delta \phi$")
		axs[0].set_ylim([0, .6])
		axs[0].set_yticks([0, .2, .4, .6])
		axs[0].set_yticklabels(['', r'$0.2$', r'$0.4$', r'$0.6$'])
		...
		(outb_FD.GenPphi - outb_FD.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'r', ax = axs[1])
		(outb_FD_corr.GenPphi - outb_FD_corr.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'b', ax = axs[1])
		axs[1].set_title("Outb. FD  " + r"$\delta \phi$")
		axs[1].set_ylim([0, .6])
		axs[1].set_yticks([0, .2, .4, .6])
		axs[1].set_yticklabels(['', r'$0.2$', r'$0.4$', r'$0.6$'])
		...
		(inb_CD.GenPphi - inb_CD.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'r', ax = axs[2])
		(inb_CD_corr.GenPphi - inb_CD_corr.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'b', ax = axs[2])
		axs[2].set_title("Inb. CD  " + r"$\delta \phi$")
		axs[2].set_ylim([0, 1.5])
		axs[2].set_yticks([0, .5, 1, 1.5])
		axs[2].set_yticklabels(['', r'$0.5$', r'$1$', r'$1.5$'])
		...
		(outb_CD.GenPphi - outb_CD.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'r', ax = axs[3])
		(outb_CD_corr.GenPphi - outb_CD_corr.Pphi).hist(bins = bins_phi, histtype = 'step', density = True, edgecolor = 'b', ax = axs[3])
		axs[3].set_title("Outb. CD  " + r"$\delta \phi$")
		axs[3].set_ylim([0, 1.5])
		axs[3].set_yticks([0, .5, 1, 1.5])
		axs[3].set_yticklabels(['', r'$0.5$', r'$1$', r'$1.5$'])
		# axs[3].set_ylim([0, 300000])
...
if chapter == 5:
	...
	if args.figureofmerit == "tables":
		...
		print("$ub_{\\phi_{H\Gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_3sigma["coplanarity_ub"], cuts_dvcs_CD_Inb_3sigma["coplanarity_ub"], cuts_dvcs_CDFT_Inb_3sigma["coplanarity_ub"], cuts_dvcs_FD_Outb_3sigma["coplanarity_ub"], cuts_dvcs_CD_Outb_3sigma["coplanarity_ub"], cuts_dvcs_CDFT_Outb_3sigma["coplanarity_ub"]))
		...
		print("$ub_{\\phi_{H\Gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_2sigma["coplanarity_ub"], cuts_dvcs_CD_Inb_2sigma["coplanarity_ub"], cuts_dvcs_CDFT_Inb_2sigma["coplanarity_ub"], cuts_dvcs_FD_Outb_2sigma["coplanarity_ub"], cuts_dvcs_CD_Outb_2sigma["coplanarity_ub"], cuts_dvcs_CDFT_Outb_2sigma["coplanarity_ub"]))
		print("\n")
		print("\n")
		...
		print("$ub_{\\phi_{H\Gamma}}"+"$&{}&{}&{}&{}&{}&{}\\\\".format(cuts_dvcs_FD_Inb_4sigma["coplanarity_ub"], cuts_dvcs_CD_Inb_4sigma["coplanarity_ub"], cuts_dvcs_CDFT_Inb_4sigma["coplanarity_ub"], cuts_dvcs_FD_Outb_4sigma["coplanarity_ub"], cuts_dvcs_CD_Outb_4sigma["coplanarity_ub"], cuts_dvcs_CDFT_Outb_4sigma["coplanarity_ub"]))
		print("\n")
		print("\n")
	...
	if args.figureofmerit == "statistics":
		...
		dfs =pd.read_pickle("/volatile/clas12/sangbaek/nov2021/convPkl_full/inb/exp/dvcs.pkl".format(run))
		print("Exp BH-DVCS Inb. \t", len(dfs))
		...
		dfs =pd.read_pickle("/volatile/clas12/sangbaek/nov2021/convPkl_full/outb/exp/dvcs.pkl".format(run))
		print("Exp BH-DVCS Outb. \t", len(dfs))
		...
		dfs =pd.read_pickle("/volatile/clas12/sangbaek/nov2021/convPkl_full/inb/exp/pi0.pkl".format(run))
		print("Exp DVpi0P Inb. \t", len(dfs))
		pi0Exp_inb_fdfd = statdf(dfs, config = 1)
		pi0Exp_inb_cdfd = statdf(dfs, config = 2)
		pi0Exp_inb_cdft = statdf(dfs, config = 3)

		dfs =pd.read_pickle("/volatile/clas12/sangbaek/nov2021/convPkl_full/outb/exp/pi0.pkl".format(run))
		print("Exp DVpi0P Outb. \t", len(dfs))
		...
		print("&Exp. (FD, FD)  & {} & {} & {}  & {}  \\\\".format(bhExp_inb_fdfd, bhdvcsExp_inb_fdfd, pi0Exp_inb_fdfd,  bkg1gExp_inb_fdfd))
		print("&Exp. (CD, FD)  & {} & {} & {}  & {}  \\\\".format(bhExp_inb_cdfd, bhdvcsExp_inb_cdfd, pi0Exp_inb_cdfd,  bkg1gExp_inb_cdfd))
		print("&Exp. (CD, FT)  & {} & {} & {}  & {}  \\\\ \\hline".format(bhExp_inb_cdft, bhdvcsExp_inb_cdft, pi0Exp_inb_cdft,  bkg1gExp_inb_cdft))
		...
		print("&Exp. (FD, FD)  & {} & {} & {}  & {}  \\\\".format(bhExp_outb_fdfd, bhdvcsExp_outb_fdfd, pi0Exp_outb_fdfd,  bkg1gExp_outb_fdfd))
		print("&Exp. (CD, FD)  & {} & {} & {}  & {}  \\\\".format(bhExp_outb_cdfd, bhdvcsExp_outb_cdfd, pi0Exp_outb_cdfd,  bkg1gExp_outb_cdfd))
		print("&Exp. (CD, FT)  & {} & {} & {}  & {}  \\\\ \\hline\\hline".format(bhExp_outb_cdft, bhdvcsExp_outb_cdft, pi0Exp_outb_cdft,  bkg1gExp_outb_cdft))
		print("\\end{tabular}")
...
if chapter == 6:
	...
	if args.figureofmerit == "proton":
		...
		fig, axs = plt.subplots(1, 1, figsize = (8, 5))
		expSample.loc[(expSample.config==3), "Ptheta"].hist(bins = np.linspace(40, 70, 201), histtype = 'step', density = True, ax = axs, color = 'k', label = 'Experimental Data')
		dvcsSample.loc[(dvcsSample.config==3), "Ptheta"].hist(bins = np.linspace(40, 70, 201), histtype = 'step', density = True, ax = axs, color = 'r', label = 'Simulation')
		plt.axvline(64.23, color = 'k', linestyle = '--', linewidth = 2)
		plt.legend(loc='lower left', bbox_to_anchor = (0.6, 0.65), framealpha = 0.5)
		plt.xlabel(r"$\theta_{p'}$" + " ["+degree+"]")
		axs.set_title("(a)", loc = 'left')
		...
		# axs.set_ylim([0, 0.1])
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/precut_pfid_cd.pdf")
		plt.clf()
		...
		# axs.set_ylim([0, 0.1])
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/precut_pfid_cd_outb.pdf")
		plt.clf()
	...
	if polarity == "inbending":
		...
		parent_MC_bkg2g = "/volatile/clas12/sangbaek/nov2021/convPkl_full_noEloss/inb/bkg_2g/"
		parent_exp = "/volatile/clas12/sangbaek/nov2021/convPkl_full_noEloss/inb/exp/"
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/dvcsInbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/dvcsInbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/pi0InbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/pi0InbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/pi0InbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()

	else:
		parent_MC = "/volatile/clas12/sangbaek/nov2021/convPkl_full_noEloss/outb/dvcs/"
		parent_MC_bkg1g = "/volatile/clas12/sangbaek/nov2021/convPkl_full_noEloss/outb/bkg_1g/"
		parent_MC_bkg2g = "/volatile/clas12/sangbaek/nov2021/convPkl_full_noEloss/outb/bkg_2g/"
		parent_exp = "/volatile/clas12/sangbaek/nov2021/convPkl_full_noEloss/outb/exp/"
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/dvcsOutbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/dvcsOutbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/dvcsOutbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/pi0OutbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
		...
		lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
		plt.tight_layout()
		plt.savefig("plots_noEloss/ch6/pi0OutbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
		plt.clf()
