...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		print("$p'$ CVT &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pcvt, 100*InbSim_effect_Pcvt, 100*InbExp_effect_Pcv/InbSim_effect_Pcv, 100*OutbExp_effect_Pcvt, 100*OutbSim_effect_Pcvt, 100*OutbExp_effect_Pcv/OutbSim_effect_Pcv))
