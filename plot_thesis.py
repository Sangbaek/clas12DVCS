...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		print(sum(InbExp.loc[:, "EFid_dw"]))
		print(sum(InbExp.loc[:, "EFid_sf"]))
		print(sum(InbExp.loc[:, "EFid_vz"]))
		print(sum(InbExp.loc[:, "EFid_pcal"]))
		print(sum(InbExp.loc[:, "EFid_vz"]))
		print(sum(InbExp.loc[:, "EFid_edep"]))
		print(sum(InbExp.loc[:, "EFid_dc"]))
		print(sum(InbExp.loc[:, "PFid_dc"]))
		print(sum(InbExp.loc[:, "PFid_cvt"]))
		print(sum(InbExp.loc[:, "PFid_chi"]))
		print(sum(InbExp.loc[:, "PFid_vz"]))
		print(sum(InbExp.loc[:, "GFid_beta"]))
		print(sum(InbExp.loc[:, "GFid_Pcal1"]))
		print(sum(InbExp.loc[:, "GFid_Pcal2"]))
		print(sum(InbExp.loc[:, "GFid_FT"]))
