...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		InbExp_effect_PGbeta = sum(InbExp.loc[:, "GFid_beta"])/len(InbExp.loc[:, "GFid_beta"])
		InbExp_effect_PGpcal1 = sum(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal1"])/len(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal1"])
		InbExp_effect_PGpcal2 = sum(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal2"])/len(InbExp.loc[InbExp.Psector < 7, "GFid_Pcal2"])
		InbExp_effect_PGft = sum(InbExp.loc[InbExp.Psector < 7, "GFid_FT"])/len(InbExp.loc[InbExp.Psector < 7, "GFid_FT"])
		...
		InbSim_effect_PGbeta = sum(InbSim.loc[:, "GFid_beta"])/len(InbSim.loc[:, "GFid_beta"])
		InbSim_effect_PGpcal1 = sum(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal1"])/len(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal1"])
		InbSim_effect_PGpcal2 = sum(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal2"])/len(InbSim.loc[InbSim.Psector < 7, "GFid_Pcal2"])
		InbSim_effect_PGft = sum(InbSim.loc[InbSim.Psector < 7, "GFid_FT"])/len(InbSim.loc[InbSim.Psector < 7, "GFid_FT"])
		...
		OutbExp_effect_PGbeta = sum(OutbExp.loc[:, "GFid_beta"])/len(OutbExp.loc[:, "GFid_beta"])
		OutbExp_effect_PGpcal1 = sum(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal1"])/len(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal1"])
		OutbExp_effect_PGpcal2 = sum(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal2"])/len(OutbExp.loc[OutbExp.Psector < 7, "GFid_Pcal2"])
		OutbExp_effect_PGft = sum(OutbExp.loc[OutbExp.Psector < 7, "GFid_FT"])/len(OutbExp.loc[OutbExp.Psector < 7, "GFid_FT"])
		...
		OutbSim_effect_PGbeta = sum(OutbSim.loc[:, "GFid_beta"])/len(OutbSim.loc[:, "GFid_beta"])
		OutbSim_effect_PGpcal1 = sum(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal1"])/len(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal1"])
		OutbSim_effect_PGpcal2 = sum(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal2"])/len(OutbSim.loc[OutbSim.Psector < 7, "GFid_Pcal2"])
		...
		print(InbExp_effect_Edw)
		print(InbExp_effect_Esf)
		print(InbExp_effect_Evz)
		print(InbExp_effect_Epcal)
		print(InbExp_effect_Evz)
		print(InbExp_effect_Eedep)
		print(InbExp_effect_Edc)
		print(InbExp_effect_Pdc)
		print(InbExp_effect_Pcvt)
		print(InbExp_effect_Pchi)
		print(InbExp_effect_Pvz)
		print(InbExp_effect_PGbeta)
		print(InbExp_effect_PGpcal1)
		print(InbExp_effect_PGpcal2)
		print(InbExp_effect_PGft)
		print(InbSim_effect_Edw)
		print(InbSim_effect_Esf)
		print(InbSim_effect_Evz)
		print(InbSim_effect_Epcal)
		print(InbSim_effect_Evz)
		print(InbSim_effect_Eedep)
		print(InbSim_effect_Edc)
		print(InbSim_effect_Pdc)
		print(InbSim_effect_Pcvt)
		print(InbSim_effect_Pchi)
		print(InbSim_effect_Pvz)
		print(InbSim_effect_PGbeta)
		print(InbSim_effect_PGpcal1)
		print(InbSim_effect_PGpcal2)
		print(InbSim_effect_PGft)
