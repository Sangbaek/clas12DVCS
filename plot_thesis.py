...
if chapter == 5:
	...
	if args.figureofmerit == "PID":
		...
		print("$p'$ DC &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pdc, 100*InbSim_effect_Pdc, 100*OutbExp_effect_Pdc, 100*OutbSim_effect_Pdc))
		print("$p'$ CVT &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pcvt, 100*InbSim_effect_Pcvt, 100*OutbExp_effect_Pcvt, 100*OutbSim_effect_Pcvt))
		print("$p'$ $\chi$ &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pchi, 100*InbSim_effect_Pchi, 100*OutbExp_effect_Pchi, 100*OutbSim_effect_Pchi))
		print("$p'$ $vz_{e'}-$vz_{p'}$" + " &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Pvz, 100*InbSim_effect_Pvz, 100*OutbExp_effect_Pvz, 100*OutbSim_effect_Pvz))
		print("$\gamma$ $\beta$ &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gbeta, 100*InbSim_effect_Gbeta, 100*OutbExp_effect_Gbeta, 100*OutbSim_effect_Gbeta))
		print("$\gamma$ PCAL1 &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gpcal1, 100*InbSim_effect_Gpcal1, 100*OutbExp_effect_Gpcal1, 100*OutbSim_effect_Gpcal1))
		print("$\gamma$ PCAL2 &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gpcal2, 100*InbSim_effect_Gpcal2, 100*OutbExp_effect_Gpcal2, 100*OutbSim_effect_Gpcal2))
		print("$\gamma$ FT &{:.1f}%&{:.1f}%&{:.1f}%&{:.1f}% \\\\hline".format(100*InbExp_effect_Gft, 100*InbSim_effect_Gft, 100*OutbExp_effect_Gft, 100*OutbSim_effect_Gft))
		print("\n")
