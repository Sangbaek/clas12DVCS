...
class root2pickle():
    ...
    def saveDVCSvars(self, correction=None):
        ...
        # encode unassigned bin as -1
        df_epg.loc[:, "GenQ2bin"] = -1
        df_epg.loc[:, "GenxBbin"] = -1
        df_epg.loc[:, "Gentbin"] = -1
        df_epg.loc[:, "Genphibin"] = -1
        df_epg.loc[:, "GenQ2xBbin"] = -1
        df_epg.loc[:, "GenQ2xBtbin"] = -1
        df_epg.loc[:, "GenQ2xBtphibin"] = -1
        Q2xBbin = 0
