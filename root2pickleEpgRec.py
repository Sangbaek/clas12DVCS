...
class root2pickle():
    ...
    def __init__(self, fname, entry_start = None, entry_stop = None, pol = "inbending", gen = "dvcs", raw = False, detRes = False, width = "mid", smearing = 1):
        self.fname = fname

        self.determineWidth(width = width)
        self.readEPGG(entry_start = entry_start, entry_stop = entry_stop, pol = pol, gen = gen, detRes = detRes, smearing = smearing)
        self.saveDVCSvars()
        self.saveDVpi0vars()
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, pol = "inbending", gen = "dvcsnorad", detRes = False, smearing = 1):
        ...
        for Q2bin in range(len(Q2bin_i)):
            ...
            for xBbin in range(len(xBbin_i[Q2bin])):
                if xBbin == 0:
                    ...
                    df_epgg.loc[(df_epgg.Q2>=Q2bin_i[Q2bin]) & (df_epgg.Q2<Q2bin_f[Q2bin]) & (df_epgg.Q2<=2*M*(10.604-2)*df_epgg.xB) & (df_epgg.xB<xBbin_f[Q2bin][Q2bin]), "Q2xBbin"] = Q2xBbin #0
                elif xBbin < len(xBbin_i[Q2bin])-1:
                    df_epgg.loc[(df_epgg.Q2>=Q2bin_i[Q2bin]) & (df_epgg.Q2<Q2bin_f[Q2bin]) & (df_epgg.xB>=xBbin_i[Q2bin][xBbin]) & (df_epgg.xB<xBbin_f[Q2bin][Q2bin]), "xBbin"] = xBbin
                    df_epgg.loc[(df_epgg.Q2>=Q2bin_i[Q2bin]) & (df_epgg.Q2<Q2bin_f[Q2bin]) & (df_epgg.xB>=xBbin_i[Q2bin][xBbin]) & (df_epgg.xB<xBbin_f[Q2bin][Q2bin]), "Q2xBbin"] = Q2xBbin
                else:
        ...
        for Q2bin in range(len(Q2bin_i)):
            ...
            for xBbin in range(len(xBbin_i[Q2bin])):
                if xBbin == 0:
                    ...
                    df_epg.loc[(df_epg.Q2>=Q2bin_i[Q2bin]) & (df_epg.Q2<Q2bin_f[Q2bin]) & (df_epg.Q2<=2*M*(10.604-2)*df_epg.xB) & (df_epg.xB<xBbin_f[Q2bin][Q2bin]), "Q2xBbin"] = Q2xBbin #0
                elif xBbin < len(xBbin_i[Q2bin])-1:
                    df_epg.loc[(df_epg.Q2>=Q2bin_i[Q2bin]) & (df_epg.Q2<Q2bin_f[Q2bin]) & (df_epg.xB>=xBbin_i[Q2bin][xBbin]) & (df_epg.xB<xBbin_f[Q2bin][Q2bin]), "xBbin"] = xBbin
                    df_epg.loc[(df_epg.Q2>=Q2bin_i[Q2bin]) & (df_epg.Q2<Q2bin_f[Q2bin]) & (df_epg.xB>=xBbin_i[Q2bin][xBbin]) & (df_epg.xB<xBbin_f[Q2bin][Q2bin]), "Q2xBbin"] = Q2xBbin
                else:
    ...
    def makeDVCS(self, pol = "inbending"):
        ...
        if pol == "inbending":
            ...
            cut_cone1_CDFT = df_dvcs["coneAngle"] < np.poly1d(cuts_dvcs_CDFT_Inb["coneAngle_ub"])(df_dvcs.Gp) # coneangle
            cut_cone2_CDFT = df_dvcs["coneAngle"] > np.poly1d(cuts_dvcs_CDFT_Inb["coneAngle_lb"])(df_dvcs.Gp) # coneangle
            ...
            cut_cone1_CD = df_dvcs["coneAngle"] < np.poly1d(cuts_dvcs_CD_Inb["coneAngle_ub"])(df_dvcs.Gp) # coneangle
            cut_cone2_CD = df_dvcs["coneAngle"] > np.poly1d(cuts_dvcs_CD_Inb["coneAngle_lb"])(df_dvcs.Gp) # coneangle
            ...
            cut_cone1_FD = df_dvcs["coneAngle"] < np.poly1d(cuts_dvcs_FD_Inb["coneAngle_ub"])(df_dvcs.Gp) # coneangle
            cut_cone2_FD = df_dvcs["coneAngle"] > np.poly1d(cuts_dvcs_FD_Inb["coneAngle_lb"])(df_dvcs.Gp) # coneangle
            ...
            cut_cone1_CDFT = df_dvcs["coneAngle"] < np.poly1d(cuts_dvcs_CDFT_Outb["coneAngle_ub"])(df_dvcs.Gp) # coneangle
            cut_cone2_CDFT = df_dvcs["coneAngle"] > np.poly1d(cuts_dvcs_CDFT_Outb["coneAngle_lb"])(df_dvcs.Gp) # coneangle
            ...
            cut_cone1_CD = df_dvcs["coneAngle"] < np.poly1d(cuts_dvcs_CD_Outb["coneAngle_ub"])(df_dvcs.Gp) # coneangle
            cut_cone2_CD = df_dvcs["coneAngle"] > np.poly1d(cuts_dvcs_CD_Outb["coneAngle_lb"])(df_dvcs.Gp) # coneangle
            ...
            cut_cone1_FD = df_dvcs["coneAngle"] < np.poly1d(cuts_dvcs_FD_Outb["coneAngle_ub"])(df_dvcs.Gp) # coneangle
            cut_cone2_FD = df_dvcs["coneAngle"] > np.poly1d(cuts_dvcs_FD_Outb["coneAngle_lb"])(df_dvcs.Gp) # coneangle
...
if __name__ == "__main__":
    ...
    parser.add_argument("-w","--width", help="width of selection cuts", default = "mid")
    ...
    converter = root2pickle(args.fname, entry_start = args.entry_start, entry_stop = args.entry_stop, pol = args.polarity, gen = args.generator, raw = args.raw, detRes = args.detRes, width = args.width, smearing = smearingFactor)
    df = converter.df
