...
class root2pickle():
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, pol = "inbending", gen = "dvcsnorad", detRes = False):
        ...
        #FD photon
        df_gammaRec.loc[df_gammaRec["Gsector"]<7, "Gp"] = df_gammaRec.loc[df_gammaRec["Gsector"]<7, "Gp"]*np.random.normal(1, 0.0395/(1+np.exp(5.308*(df_gammaRec.loc[df_gammaRec["Gsector"]<7, "Gtheta"]- 8.005))), len(df_gammaRec.loc[df_gammaRec.Gsector<7]))
        ...
        sigmas_CD = (-2.768*df_protonRec.loc[df_protonRec["Psector"]>7, "Pp"]**3 + 12.549*df_protonRec.loc[df_protonRec["Psector"]>7, "Pp"]**2 - 15.192*df_protonRec.loc[df_protonRec["Psector"]>7, "Pp"] + 9.934)
        ...
        if pol == "inbending":
            ...
            sigmas_FD = np.select([df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]<1.3, (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]>=1.3) & (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]<1.9), df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]>=1.9], [0.06, -(0.06-0.04)/(1.9-1.3)*df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]+(0.06-0.04)/(1.9-1.3)*1.9+0.04, 0.04])
        elif pol == "outbending":
            regulator = (1/(1+np.exp(-(df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]-0.6)/0.05)))
            sigmas_FD = np.select([df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]<.95, (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]>=.95) & (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]<1.2), (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]>=1.2)&(df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]<1.575), (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]>=1.575) & (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]<1.9), (df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]>1.9)], [0.08, -0.025/(1.2-.95)*df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]+1.2*0.025/(1.2-.95) + 0.055, 0.055, -0.015/(1.9-1.575)*df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]+1.9*0.015/(1.9-1.575) + 0.04,0.04])
        df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"] = df_protonRec.loc[df_protonRec["Psector"]<7, "Pp"]*np.random.normal(1, regulator*sigmas_FD, len(df_protonRec.loc[df_protonRec.Psector<7]))
    ...
    def makeDVpi0P_DVCS(self, pol = "inbending"):
        ...
        if pol == 'inbending':
            ...
            cut_mmepgg1_CDFT = np.abs(df_dvpi0p["MM2_epgg"]) < 0.0401  # mmepgg
            cut_mmepgg2_CDFT = np.abs(df_dvpi0p["MM2_epgg"]) > -0.0438  # mmepgg
            ...
            cut_mmepgg1_CD = np.abs(df_dvpi0p["MM2_epgg"]) < 0.0266  # mmepgg
            cut_mmepgg2_CD = np.abs(df_dvpi0p["MM2_epgg"]) > -0.0311
              # mmepgg
            ...
            cut_mmepgg2_FD = np.abs(df_dvpi0p["MM2_epgg"]) > -0.0279  # mmepgg
            ...
            cut_mmepgg1_CDFT = np.abs(df_dvpi0p["MM2_epgg"]) < 0.0413  # mmepgg
            cut_mmepgg2_CDFT = np.abs(df_dvpi0p["MM2_epgg"]) > -0.0440  # mmepgg
            ...
            cut_mmepgg1_CD = np.abs(df_dvpi0p["MM2_epgg"]) < 0.0257  # mmepgg
            cut_mmepgg2_CD = np.abs(df_dvpi0p["MM2_epgg"]) > -0.0302  # mmepgg
            ...
            cut_mmepgg1_FD = np.abs(df_dvpi0p["MM2_epgg"]) < 0.0354  # mmepgg
            cut_mmepgg2_FD = np.abs(df_dvpi0p["MM2_epgg"]) > -0.0480  # mmepgg
    ...
    def makeDVCS(self, pol = "inbending"):
        ...
        if pol == "inbending":
            ...
            cut_Ptheta_CDFT = df_dvcs.Ptheta<90
            ...
            cut_Ptheta_CD = df_dvcs.Ptheta<90
