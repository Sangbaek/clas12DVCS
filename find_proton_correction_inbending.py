...
for run in inb_list:
    ...
    df = df.loc[:, ["MM2_ep", "reconGam", "Pp", "Ptheta", "Pphi", "Ppx", "Ppy", "Ppz", "Epx", "Epy", "Epz", "Gpx", "Gpy", "Gpz", "Psector"]]
    ...
    df = df.loc[:, ["MM2_ep", "reconPi", "Pp", "Ptheta", "Pphi", "Ppx", "Ppy", "Ppz", "Epx", "Epy", "Epz", "Gpx", "Gpy", "Gpz", "Gpx2", "Gpy2", "Gpz2", "Psector"]]
...
for bin in range(147):
    try:
        ...
        df = df.loc[:, ["MM2_ep", "reconGam", "Pp", "Ptheta", "Pphi", "Ppx", "Ppy", "Ppz", "Epx", "Epy", "Epz", "Gpx", "Gpy", "Gpz", "Psector", "weights"]]
    ...
    for i in range(len(Pbins)-1):
        ...
        for row in range(len(optimal_dps)):
         ...
         # this_row = pd.DataFrame.from_dict({"Psector": [Psector], "p": [Pcenter], "dp": [optimal_dp], "dtheta": [optimal_dtheta], "dp_std": [optimal_dp_std], "dtheta_std": [optimal_dtheta_std], "polarity": ["inbending"]})
          this_row = pd.DataFrame.from_dict({"Psector": [Psector], "p": [Pcenter], "dp": [optimal_dp], "dtheta": [optimal_dtheta], "score": [score], "polarity": ["inbending"]})
