...
class root2pickle():
    ...
    def __init__(self, fname, entry_start = None, entry_stop = None, pol = "inbending", detRes = False, width = "mid", logistics = False, nofid = False, nocorr = False, fidlevel = 'mid', allowsamesector = False, ebeam = 10.604):
        '''
            clas init.
            Args
            --------------------
