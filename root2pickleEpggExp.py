...
class root2pickle():
    ...
    def __init__(self, fname, entry_start = None, entry_stop = None, pol = "inbending", 
        detRes = False, raw = False, width = "mid", logistics = False, nofid = False, nocorr = False, noeloss = False, nopcorr = False, nogcorr = False,
...
if __name__ == "__main__":
    ...
    converter = root2pickle(args.fname, entry_start = args.entry_start, 
        ...
        width = args.width, logistics = args.logistics, nofid = args.nofid, nocorr = args.nocorr, noeloss = args.noeloss, nopcorr = args.nopcorr,nogcorr = args.nogcorr,
