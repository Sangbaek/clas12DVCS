...
class root2pickle():
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, pol = "inbending", detRes = False, logistics = False):
        ...
        if correction:
            df_gg.loc[df_gg["Gsector"]>7, "Gp"] = df_gg.loc[df_gg["Gsector"]>7, "Gp"] -0.00164 * df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"]**2 + 0.04377 * df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"]
