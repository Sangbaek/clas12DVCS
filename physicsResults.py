...
if args.savecont:
	...
	for i in range(len(collection_cont_xBbins)):
		...
		histBkgInbFD_plus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == 1) & (df_bkg1gs_inb.config == 1) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefInbFD_plus, bins = np.histogramdd(df_bkg2gs_inb.loc[(df_bkg2gs_inb.helicity == 1) & (df_bkg2gs_inb.config == 1) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbCD_plus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == 1) & (df_bkg1gs_inb.config == 2) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefInbCD_plus, bins = np.histogramdd(df_bkg2gs_inb.loc[(df_bkg2gs_inb.helicity == 1) & (df_bkg2gs_inb.config == 2) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbCDFT_plus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == 1) & (df_bkg1gs_inb.config == 3) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefInbCDFT, bins = np.histogramdd(df_bkg2gs_inb.loc[(df_bkg2gs_inb.helicity == 1) & (df_bkg2gs_inb.config == 3) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbCR_plus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == 1) & (df_bkg1gs_inb.config == 4) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbFD_plus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == 1) & (df_bkg1gs_outb.config == 1), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefOutbFD_plus, bins = np.histogramdd(df_bkg2gs_outb.loc[(df_bkg2gs_outb.helicity == 1) & (df_bkg2gs_outb.config == 1), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbCD_plus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == 1) & (df_bkg1gs_outb.config == 2), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefOutbCD_plus, bins = np.histogramdd(df_bkg2gs_outb.loc[(df_bkg2gs_outb.helicity == 1) & (df_bkg2gs_outb.config == 2), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbCDFT_plus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == 1) & (df_bkg1gs_outb.config == 3), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefOutbCDFT_plus, bins = np.histogramdd(df_bkg2gs_outb.loc[(df_bkg2gs_outb.helicity == 1) & (df_bkg2gs_outb.config == 3), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbCR_plus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == 1) &(df_bkg1gs_outb.config == 4) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbFD_minus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == -1) & (df_bkg1gs_inb.config == 1) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefInbFD_minus, bins = np.histogramdd(df_bkg2gs_inb.loc[(df_bkg2gs_inb.helicity == -1) & (df_bkg2gs_inb.config == 1) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbCD_minus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == 1) & (df_bkg1gs_inb.config == 2) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefInbCD_minus, bins = np.histogramdd(df_bkg2gs_inb.loc[(df_bkg2gs_inb.helicity == 1) & (df_bkg2gs_inb.config == 2) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbCDFT_minus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == -1) & (df_bkg1gs_inb.config == 3) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefInbCDFT, bins = np.histogramdd(df_bkg2gs_inb.loc[(df_bkg2gs_inb.helicity == -1) & (df_bkg2gs_inb.config == 3) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgInbCR_minus, bins = np.histogramdd(df_bkg1gs_inb.loc[(df_bkg1gs_inb.helicity == -1) & (df_bkg1gs_inb.config == 4) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbFD_minus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == -1) & (df_bkg1gs_outb.config == 1), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefOutbFD_minus, bins = np.histogramdd(df_bkg2gs_outb.loc[(df_bkg2gs_outb.helicity == -1) & (df_bkg2gs_outb.config == 1), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbCD_minus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == -1) & (df_bkg1gs_outb.config == 2), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefOutbCD_minus, bins = np.histogramdd(df_bkg2gs_outb.loc[(df_bkg2gs_outb.helicity == -1) & (df_bkg2gs_outb.config == 2), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbCDFT_minus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == -1) & (df_bkg1gs_outb.config == 3), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		histRefOutbCDFT_minus, bins = np.histogramdd(df_bkg2gs_outb.loc[(df_bkg2gs_outb.helicity == -1) & (df_bkg2gs_outb.config == 3), ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		histBkgOutbCR_minus, bins = np.histogramdd(df_bkg1gs_outb.loc[(df_bkg1gs_outb.helicity == -1) & (df_bkg1gs_outb.config == 4) , ["xB", "Q2", "t1", "phi1"]].to_numpy(), bins = [xBbins, Q2bins, tbins, phibins])
		...
		contInbFD_plus = divideHist(histBkgInbFD_plus*histPi0InbFD_plus, histRefInbFD_plus*histExpInbFD_plus)
		contInbCD_plus = divideHist(histBkgInbCD_plus*histPi0InbCD_plus, histRefInbCD_plus*histExpInbCD_plus)
		contInbCDFT_plus = divideHist(histBkgInbCDFT_plus*histPi0InbCDFT_plus, histRefInbCDFT_plus*histExpInbCDFT_plus)
		contInbCR_plus = divideHist(histBkgInbCR_plus*histPi0InbCDFT_plus, histRefInbCDFT_plus*histExpInbCR_plus)
		contOutbFD_plus = divideHist(histBkgOutbFD_plus*histPi0OutbFD_plus, histRefOutbFD_plus*histExpOutbFD_plus)
		contOutbCD_plus = divideHist(histBkgOutbCD_plus*histPi0OutbCD_plus, histRefOutbCD_plus*histExpOutbCD_plus)
		contOutbCDFT_plus = divideHist(histBkgOutbCDFT_plus*histPi0OutbCDFT_plus, histRefOutbCDFT_plus*histExpOutbCDFT_plus)
		contOutbCR_plus = divideHist(histBkgOutbCR_plus*histPi0OutbCDFT_plus, histRefOutbCDFT_plus*histExpOutbCR_plus)

		unccontInbFD_plus = contInbFD_plus*np.sqrt(inverseHist(histBkgInbFD_plus)+inverseHist(histPi0InbFD_plus)+inverseHist(histRefInbFD_plus)+inverseHist(histExpInbFD_plus))
		unccontInbCD_plus = contInbCD_plus*np.sqrt(inverseHist(histBkgInbCD_plus)+inverseHist(histPi0InbCD_plus)+inverseHist(histRefInbCD_plus)+inverseHist(histExpInbCD_plus))
		unccontInbCDFT_plus = contInbCDFT_plus*np.sqrt(inverseHist(histBkgInbCDFT_plus)+inverseHist(histPi0InbCDFT_plus)+inverseHist(histRefInbCDFT_plus)+inverseHist(histExpInbCDFT_plus))
		unccontInbCR_plus = contInbCR_plus*np.sqrt(inverseHist(histBkgInbCR_plus)+inverseHist(histPi0InbCDFT_plus)+inverseHist(histRefInbCDFT_plus)+inverseHist(histExpInbCR_plus))
		unccontOutbFD_plus = contOutbFD_plus*np.sqrt(inverseHist(histBkgOutbFD_plus)+inverseHist(histPi0OutbFD_plus)+inverseHist(histRefOutbFD_plus)+inverseHist(histExpOutbFD_plus))
		unccontOutbCD_plus = contOutbCD_plus*np.sqrt(inverseHist(histBkgOutbCD_plus)+inverseHist(histPi0OutbCD_plus)+inverseHist(histRefOutbCD_plus)+inverseHist(histExpOutbCD_plus))
		unccontOutbCDFT_plus = contOutbCDFT_plus*np.sqrt(inverseHist(histBkgOutbCDFT_plus)+inverseHist(histPi0OutbCDFT_plus)+inverseHist(histRefOutbCDFT_plus)+inverseHist(histExpOutbCDFT_plus))
		unccontOutbCR_plus = contOutbCR_plus*np.sqrt(inverseHist(histBkgOutbCR_plus)+inverseHist(histPi0OutbCDFT_plus)+inverseHist(histRefOutbCDFT_plus)+inverseHist(histExpOutbCR_plus))

		contInbFD_minus = divideHist(histBkgInbFD_minus*histPi0InbFD_minus, histRefInbFD_minus*histExpInbFD_minus)
		contInbCD_minus = divideHist(histBkgInbCD_minus*histPi0InbCD_minus, histRefInbCD_minus*histExpInbCD_minus)
		contInbCDFT_minus = divideHist(histBkgInbCDFT_minus*histPi0InbCDFT_minus, histRefInbCDFT_minus*histExpInbCDFT_minus)
		contInbCR_minus = divideHist(histBkgInbCR_minus*histPi0InbCDFT_minus, histRefInbCDFT_minus*histExpInbCR_minus)
		contOutbFD_minus = divideHist(histBkgOutbFD_minus*histPi0OutbFD_minus, histRefOutbFD_minus*histExpOutbFD_minus)
		contOutbCD_minus = divideHist(histBkgOutbCD_minus*histPi0OutbCD_minus, histRefOutbCD_minus*histExpOutbCD_minus)
		contOutbCDFT_minus = divideHist(histBkgOutbCDFT_minus*histPi0OutbCDFT_minus, histRefOutbCDFT_minus*histExpOutbCDFT_minus)
		contOutbCR_minus = divideHist(histBkgOutbCR_minus*histPi0OutbCDFT_minus, histRefOutbCDFT_minus*histExpOutbCR_minus)

		unccontInbFD_minus = contInbFD_minus*np.sqrt(inverseHist(histBkgInbFD_minus)+inverseHist(histPi0InbFD_minus)+inverseHist(histRefInbFD_minus)+inverseHist(histExpInbFD_minus))
		unccontInbCD_minus = contInbCD_minus*np.sqrt(inverseHist(histBkgInbCD_minus)+inverseHist(histPi0InbCD_minus)+inverseHist(histRefInbCD_minus)+inverseHist(histExpInbCD_minus))
		unccontInbCDFT_minus = contInbCDFT_minus*np.sqrt(inverseHist(histBkgInbCDFT_minus)+inverseHist(histPi0InbCDFT_minus)+inverseHist(histRefInbCDFT_minus)+inverseHist(histExpInbCDFT_minus))
		unccontInbCR_minus = contInbCR_minus*np.sqrt(inverseHist(histBkgInbCR_minus)+inverseHist(histPi0InbCDFT_minus)+inverseHist(histRefInbCDFT_minus)+inverseHist(histExpInbCR_minus))
		unccontOutbFD_minus = contOutbFD_minus*np.sqrt(inverseHist(histBkgOutbFD_minus)+inverseHist(histPi0OutbFD_minus)+inverseHist(histRefOutbFD_minus)+inverseHist(histExpOutbFD_minus))
		unccontOutbCD_minus = contOutbCD_minus*np.sqrt(inverseHist(histBkgOutbCD_minus)+inverseHist(histPi0OutbCD_minus)+inverseHist(histRefOutbCD_minus)+inverseHist(histExpOutbCD_minus))
		unccontOutbCDFT_minus = contOutbCDFT_minus*np.sqrt(inverseHist(histBkgOutbCDFT_minus)+inverseHist(histPi0OutbCDFT_minus)+inverseHist(histRefOutbCDFT_minus)+inverseHist(histExpOutbCDFT_minus))
		unccontOutbCR_minus = contOutbCR_minus*np.sqrt(inverseHist(histBkgOutbCR_minus)+inverseHist(histPi0OutbCDFT_minus)+inverseHist(histRefOutbCDFT_minus)+inverseHist(histExpOutbCR_minus))
