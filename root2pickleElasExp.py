...
class root2pickle():
    ...
    def makeElas(self):
        ...
        cut_FD_proton = (df_ep.loc[:, "Psector"]<7) & (df_ep.loc[:, "Ptheta"]<35)
        cut_CD_proton = (df_ep.loc[:, "Psector"]>7) & (df_ep.loc[:, "Ptheta"]>45) & (df_ep.loc[:, "Ptheta"]<65)
        ...
        df_elas_rad = df_elas_cand[cut_rad & cut_missDir & cut_exclude_pure]
