...
class root2pickle():
    ...
    def readEP(self, entry_stop = None, pol = "inbending"):
        ...
        df_protonGen = df_protonGen.rename({"px0": "GenPpx", "py0": "GenPpy", "pz0": "GenPpz"})
        ...
        #convert data type to standard double
        df_protonRec = df_protonRec.rename({"px": "Ppx", "py": "Ppy", "pz": "Ppz", "dcx1": "PDc1Hitx", "dcy1":"PDc1Hity", "dcz1": "PDc1Hitz"})
