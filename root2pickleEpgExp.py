...
class root2pickle():
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, pol = "inbending", detRes = False, logistics = False):
        ...
        if correction:
            ...
            df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"] = df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"] + 0.25 + 0.186/(1+np.exp(1.254*(df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"]-4.5)))
