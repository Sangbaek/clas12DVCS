...
class root2pickle():
    ...
    def __init__(self, fname, entry_start = None, entry_stop = None, pol = "inbending",
     detRes = False, logistics = False, width = "mid", nofid = False, nocorr = False, noeloss = False, nopcorr = False,
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, pol = "inbending", 
        ...
        if nocorr:
            ...
            CorrectedPp_FD_1, CorrectedPtheta_FD_1, CorrectedPphi_FD_1 = (
                protonEnergyLossCorrection(pol, "FD lower", df_protonRecFD_1))
            CorrectedPp_FD_2, CorrectedPtheta_FD_2, CorrectedPphi_FD_2 = (
                protonEnergyLossCorrection(pol, "FD upper", df_protonRecFD_2))
            CorrectedPp_CD, CorrectedPtheta_CD, CorrectedPphi_CD = (
                protonEnergyLossCorrection(pol, "CD", df_protonRecCD))
