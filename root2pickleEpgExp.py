...
class root2pickle():
    ...
    def __init__(self, fname, entry_start = None, entry_stop = None, pol = "inbending", detRes = False, logistics = False, width = "mid", nofid = False, fidlevel = 'mid'):
        '''
            clas init.
            Args
            --------------------
...
if __name__ == "__main__":
    ...
    converter = root2pickle(args.fname, entry_start = args.entry_start, entry_stop = args.entry_stop, pol = args.polarity, detRes = args.detRes, logistics = args.logistics, width = args.width, nofid = args.nofid, fidlevel = args.fidlevel)
    df = converter.df
