...
class root2pickle():
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, pol = "inbending", detRes = False, logistics = False):
        ...
        if correction:
            ...
            df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"] = df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"] -0.00164 * df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"]**2 + 0.04377 * df_gammaRec.loc[df_gammaRec["Gsector"]>7, "Gp"]
    ...
    def makeDVCS(self, pol = "inbending"):
        ...
        if pol == "inbending":
            ...
            cut_Ptheta_CDFT = df_dvcs.Ptheta<70
            ...
            cut_Ptheta_CD = df_dvcs.Ptheta<70
