...
def protonEnergyLossCorr(pol, df_protonRec):
    ...
    if pol == "inbending":
        ...
        CorrectedPp_FD_1 = np.select([df_protonRecFD_1.Pp<1.4, df_protonRecFD_1.Pp>=1.4], [const_FD + coeff_FD/df_protonRecFD_1.loc[:, "Pp"] + df_protonRecFD_1.loc[:, "Pp"], np.exp(-2.739 - 3.932*df_protonRecFD_1.Pp) + 0.002907+df_protonRecFD_1.Pp])
        ...
        CorrectedPp_FD_2 = np.select([df_protonRecFD_2.Pp<1.4, df_protonRecFD_2.Pp>=1.4], [const_FD + coeff_FD/df_protonRecFD_2.loc[:, "Pp"] + df_protonRecFD_2.loc[:, "Pp"], np.exp(-1.2 - 4.228*df_protonRecFD_2.Pp) + 0.007502+df_protonRecFD_2.Pp])
    ...
    #outbending proton energy loss correction
        ...
        CorrectedPp_FD_2 = np.select([df_protonRecFD_2.Pp<1.4, df_protonRecFD_2.Pp>=1.4], [const_FD + coeff_FD/df_protonRecFD_2.loc[:, "Pp"] + df_protonRecFD_2.loc[:, "Pp"], np.exp(-1.871 - 3.063*df_protonRecFD_2.Pp) + 0.007517 + df_protonRecFD_2.Pp])
