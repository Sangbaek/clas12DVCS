...
def assign_efficiency(df_Rec, mc = False, pol = "inbending"):
	...
	df_Rec.loc[:, "Pthetaefficiency_vgg"] = 1
	df_Rec.loc[:, "Pthetaefficiency_pi0"] = 1
	if pol == "inbending":
		...
		df_Rec.loc[(df_Rec.Psector == 3), "Pthetaefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Ptheta"], *popt_Pthetaefficiency[4])
		df_Rec.loc[(df_Rec.Psector == 4), "Pthetaefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Ptheta"], *popt_Pthetaefficiency[6])
		...
		df_Rec.loc[(df_Rec.Psector == 1), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Ptheta"], *popt_Pthetaefficiency_vgg[0])
		df_Rec.loc[(df_Rec.Psector == 2), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Ptheta"], *popt_Pthetaefficiency_vgg[2])
		df_Rec.loc[(df_Rec.Psector == 3), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Ptheta"], *popt_Pthetaefficiency_vgg[4])
		df_Rec.loc[(df_Rec.Psector == 4), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Ptheta"], *popt_Pthetaefficiency_vgg[6])
		df_Rec.loc[(df_Rec.Psector == 5), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Ptheta"], *popt_Pthetaefficiency_vgg[8])
		df_Rec.loc[(df_Rec.Psector == 6), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Ptheta"], *popt_Pthetaefficiency_vgg[10])
		df_Rec.loc[(df_Rec.Psector >  7), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Ptheta"], *popt_Pthetaefficiency_vgg[12])
		df_Rec.loc[(df_Rec.Psector == 1), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Ptheta"], *popt_Pthetaefficiency_pi0[0])
		df_Rec.loc[(df_Rec.Psector == 2), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Ptheta"], *popt_Pthetaefficiency_pi0[2])
		df_Rec.loc[(df_Rec.Psector == 3), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Ptheta"], *popt_Pthetaefficiency_pi0[4])
		df_Rec.loc[(df_Rec.Psector == 4), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Ptheta"], *popt_Pthetaefficiency_pi0[6])
		df_Rec.loc[(df_Rec.Psector == 5), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Ptheta"], *popt_Pthetaefficiency_pi0[8])
		df_Rec.loc[(df_Rec.Psector == 6), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Ptheta"], *popt_Pthetaefficiency_pi0[10])
		df_Rec.loc[(df_Rec.Psector >  7), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Ptheta"], *popt_Pthetaefficiency_pi0[12])
	if pol == "outbending":
		...
		df_Rec.loc[(df_Rec.Psector == 3), "Pthetaefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Ptheta"], *popt_Pthetaefficiency[5])
		df_Rec.loc[(df_Rec.Psector == 4), "Pthetaefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Ptheta"], *popt_Pthetaefficiency[7])
		...
		df_Rec.loc[(df_Rec.Psector == 1), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Ptheta"], *popt_Pthetaefficiency_vgg[1])
		df_Rec.loc[(df_Rec.Psector == 2), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Ptheta"], *popt_Pthetaefficiency_vgg[3])
		df_Rec.loc[(df_Rec.Psector == 3), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Ptheta"], *popt_Pthetaefficiency_vgg[5])
		df_Rec.loc[(df_Rec.Psector == 4), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Ptheta"], *popt_Pthetaefficiency_vgg[7])
		df_Rec.loc[(df_Rec.Psector == 5), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Ptheta"], *popt_Pthetaefficiency_vgg[9])
		df_Rec.loc[(df_Rec.Psector == 6), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Ptheta"], *popt_Pthetaefficiency_vgg[11])
		df_Rec.loc[(df_Rec.Psector >  7), "Pthetaefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Ptheta"], *popt_Pthetaefficiency_vgg[13])
		df_Rec.loc[(df_Rec.Psector == 1), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Ptheta"], *popt_Pthetaefficiency_pi0[1])
		df_Rec.loc[(df_Rec.Psector == 2), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Ptheta"], *popt_Pthetaefficiency_pi0[3])
		df_Rec.loc[(df_Rec.Psector == 3), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Ptheta"], *popt_Pthetaefficiency_pi0[5])
		df_Rec.loc[(df_Rec.Psector == 4), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Ptheta"], *popt_Pthetaefficiency_pi0[7])
		df_Rec.loc[(df_Rec.Psector == 5), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Ptheta"], *popt_Pthetaefficiency_pi0[9])
		df_Rec.loc[(df_Rec.Psector == 6), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Ptheta"], *popt_Pthetaefficiency_pi0[11])
		df_Rec.loc[(df_Rec.Psector >  7), "Pthetaefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Ptheta"], *popt_Pthetaefficiency_pi0[13])

	df_Rec.loc[:, "Ppefficiency"] = 1
	df_Rec.loc[:, "Ppefficiency_bh"] = 1
	df_Rec.loc[:, "Ppefficiency_vgg"] = 1
	df_Rec.loc[:, "Ppefficiency_pi0"] = 1
	if pol == "inbending":
		...
		df_Rec.loc[(df_Rec.Psector == 3), "Ppefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Pp"], *popt_Ppefficiency[4])
		df_Rec.loc[(df_Rec.Psector == 4), "Ppefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Pp"], *popt_Ppefficiency[6])
		...
		df_Rec.loc[(df_Rec.Psector == 1), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Pp"], *popt_Ppefficiency_vgg[0])
		df_Rec.loc[(df_Rec.Psector == 2), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Pp"], *popt_Ppefficiency_vgg[2])
		df_Rec.loc[(df_Rec.Psector == 3), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Pp"], *popt_Ppefficiency_vgg[4])
		df_Rec.loc[(df_Rec.Psector == 4), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Pp"], *popt_Ppefficiency_vgg[6])
		df_Rec.loc[(df_Rec.Psector == 5), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Pp"], *popt_Ppefficiency_vgg[8])
		df_Rec.loc[(df_Rec.Psector == 6), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Pp"], *popt_Ppefficiency_vgg[10])
		df_Rec.loc[(df_Rec.Psector >  7), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Pp"], *popt_Ppefficiency_vgg[12])
		df_Rec.loc[(df_Rec.Psector == 1), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Pp"], *popt_Ppefficiency_pi0[0])
		df_Rec.loc[(df_Rec.Psector == 2), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Pp"], *popt_Ppefficiency_pi0[2])
		df_Rec.loc[(df_Rec.Psector == 3), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Pp"], *popt_Ppefficiency_pi0[4])
		df_Rec.loc[(df_Rec.Psector == 4), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Pp"], *popt_Ppefficiency_pi0[6])
		df_Rec.loc[(df_Rec.Psector == 5), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Pp"], *popt_Ppefficiency_pi0[8])
		df_Rec.loc[(df_Rec.Psector == 6), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Pp"], *popt_Ppefficiency_pi0[10])
		df_Rec.loc[(df_Rec.Psector >  7), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Pp"], *popt_Ppefficiency_pi0[12])
	if pol == "outbending":
		...
		df_Rec.loc[(df_Rec.Psector == 3), "Ppefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Pp"], *popt_Ppefficiency[5])
		df_Rec.loc[(df_Rec.Psector == 4), "Ppefficiency"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Pp"], *popt_Ppefficiency[7])
		...
		df_Rec.loc[(df_Rec.Psector == 1), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Pp"], *popt_Ppefficiency_vgg[1])
		df_Rec.loc[(df_Rec.Psector == 2), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Pp"], *popt_Ppefficiency_vgg[3])
		df_Rec.loc[(df_Rec.Psector == 3), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Pp"], *popt_Ppefficiency_vgg[5])
		df_Rec.loc[(df_Rec.Psector == 4), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Pp"], *popt_Ppefficiency_vgg[7])
		df_Rec.loc[(df_Rec.Psector == 5), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Pp"], *popt_Ppefficiency_vgg[9])
		df_Rec.loc[(df_Rec.Psector == 6), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Pp"], *popt_Ppefficiency_vgg[11])
		df_Rec.loc[(df_Rec.Psector >  7), "Ppefficiency_vgg"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Pp"], *popt_Ppefficiency_vgg[13])
		df_Rec.loc[(df_Rec.Psector == 1), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 1), "Pp"], *popt_Ppefficiency_pi0[1])
		df_Rec.loc[(df_Rec.Psector == 2), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 2), "Pp"], *popt_Ppefficiency_pi0[3])
		df_Rec.loc[(df_Rec.Psector == 3), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 3), "Pp"], *popt_Ppefficiency_pi0[5])
		df_Rec.loc[(df_Rec.Psector == 4), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 4), "Pp"], *popt_Ppefficiency_pi0[7])
		df_Rec.loc[(df_Rec.Psector == 5), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 5), "Pp"], *popt_Ppefficiency_pi0[9])
		df_Rec.loc[(df_Rec.Psector == 6), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector == 6), "Pp"], *popt_Ppefficiency_pi0[11])
		df_Rec.loc[(df_Rec.Psector >  7), "Ppefficiency_pi0"] = quartic_efficiency(df_Rec.loc[(df_Rec.Psector >  7), "Pp"], *popt_Ppefficiency_pi0[13])

	df_Rec.loc[:, "Pphiefficiency"] = 1
	df_Rec.loc[:, "Pphiefficiency_bh"] = 1
	df_Rec.loc[:, "Pphiefficiency_vgg"] = 1
	df_Rec.loc[:, "Pphiefficiency_pi0"] = 1
	if pol == "inbending":
		for i in range(len(pphi_bins)-1):
			df_Rec.loc[(df_Rec.Psector == 1) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_fd_sector_1[i]
			df_Rec.loc[(df_Rec.Psector == 2) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_fd_sector_2[i]
			df_Rec.loc[(df_Rec.Psector == 3) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_fd_sector_3[i]
			df_Rec.loc[(df_Rec.Psector == 4) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_fd_sector_4[i]
			df_Rec.loc[(df_Rec.Psector == 5) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_fd_sector_5[i]
			df_Rec.loc[(df_Rec.Psector == 6) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_fd_sector_6[i]
			df_Rec.loc[(df_Rec.Psector >  7) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_inb_cd[i]
			df_Rec.loc[(df_Rec.Psector == 1) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_fd_sector_1_bh[i]
			df_Rec.loc[(df_Rec.Psector == 2) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_fd_sector_2_bh[i]
			df_Rec.loc[(df_Rec.Psector == 3) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_fd_sector_3_bh[i]
			df_Rec.loc[(df_Rec.Psector == 4) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_fd_sector_4_bh[i]
			df_Rec.loc[(df_Rec.Psector == 5) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_fd_sector_5_bh[i]
			df_Rec.loc[(df_Rec.Psector == 6) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_fd_sector_6_bh[i]
			df_Rec.loc[(df_Rec.Psector >  7) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_inb_cd_bh[i]
			df_Rec.loc[(df_Rec.Psector == 1) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_fd_sector_1_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 2) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_fd_sector_2_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 3) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_fd_sector_3_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 4) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_fd_sector_4_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 5) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_fd_sector_5_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 6) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_fd_sector_6_vgg[i]
			df_Rec.loc[(df_Rec.Psector >  7) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_inb_cd_vgg[i]
	if pol == "outbending":
		for i in range(len(pphi_bins)-1):
			df_Rec.loc[(df_Rec.Psector == 1) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_fd_sector_1[i]
			df_Rec.loc[(df_Rec.Psector == 2) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_fd_sector_2[i]
			df_Rec.loc[(df_Rec.Psector == 3) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_fd_sector_3[i]
			df_Rec.loc[(df_Rec.Psector == 4) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_fd_sector_4[i]
			df_Rec.loc[(df_Rec.Psector == 5) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_fd_sector_5[i]
			df_Rec.loc[(df_Rec.Psector == 6) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_fd_sector_6[i]
			df_Rec.loc[(df_Rec.Psector >  7) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency"] = Pphiefficiency_outb_cd[i]
			df_Rec.loc[(df_Rec.Psector == 1) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_fd_sector_1_bh[i]
			df_Rec.loc[(df_Rec.Psector == 2) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_fd_sector_2_bh[i]
			df_Rec.loc[(df_Rec.Psector == 3) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_fd_sector_3_bh[i]
			df_Rec.loc[(df_Rec.Psector == 4) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_fd_sector_4_bh[i]
			df_Rec.loc[(df_Rec.Psector == 5) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_fd_sector_5_bh[i]
			df_Rec.loc[(df_Rec.Psector == 6) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_fd_sector_6_bh[i]
			df_Rec.loc[(df_Rec.Psector >  7) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_bh"] = Pphiefficiency_outb_cd_bh[i]
			df_Rec.loc[(df_Rec.Psector == 1) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_fd_sector_1_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 2) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_fd_sector_2_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 3) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_fd_sector_3_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 4) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_fd_sector_4_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 5) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_fd_sector_5_vgg[i]
			df_Rec.loc[(df_Rec.Psector == 6) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_fd_sector_6_vgg[i]
			df_Rec.loc[(df_Rec.Psector >  7) & (df_Rec.Pphi>pphi_bins[i]) & (df_Rec.Pphi<pphi_bins[i+1]), "Pphiefficiency_vgg"] = Pphiefficiency_outb_cd_vgg[i]
	...
	df_Rec.loc[df_Rec.Pthetaefficiency>1.5, "Pthetaefficiency"] = 1.5
	df_Rec.loc[df_Rec.Ppefficiency<0.5, "Ppefficiency"] = 0.5
	...
	df_Rec.loc[df_Rec.Pthetaefficiency_vgg<0.1, "Pthetaefficiency_vgg"] = 0.1
	df_Rec.loc[df_Rec.Pthetaefficiency_vgg>1.5, "Pthetaefficiency_vgg"] = 1.5
	df_Rec.loc[df_Rec.Ppefficiency_vgg<0.5, "Ppefficiency_vgg"] = 0.5
	df_Rec.loc[df_Rec.Ppefficiency_vgg>1.5, "Ppefficiency_vgg"] = 1.5
	df_Rec.loc[df_Rec.Pphiefficiency_vgg<0.5, "Pphiefficiency_vgg"] = 0.5
	df_Rec.loc[df_Rec.Pphiefficiency_vgg>1.5, "Pphiefficiency_vgg"] = 1.5

	df_Rec.loc[df_Rec.Pthetaefficiency_pi0<0.1, "Pthetaefficiency_pi0"] = 0.1
	df_Rec.loc[df_Rec.Pthetaefficiency_pi0>1.5, "Pthetaefficiency_pi0"] = 1.5
	df_Rec.loc[df_Rec.Ppefficiency_pi0<0.5, "Ppefficiency_pi0"] = 0.5
	df_Rec.loc[df_Rec.Ppefficiency_pi0>1.5, "Ppefficiency_pi0"] = 1.5
	df_Rec.loc[df_Rec.Pphiefficiency_pi0<0.5, "Pphiefficiency_pi0"] = 0.5
	df_Rec.loc[df_Rec.Pphiefficiency_pi0>1.5, "Pphiefficiency_pi0"] = 1.5
	...
	if not mc:
		...
		df_Rec.loc[:, "efficiency_pi0"] = df_Rec.Pthetaefficiency_pi0 * df_Rec.Ppefficiency_pi0 * df_Rec.Pphiefficiency_pi0


		df_Rec.loc[df_Rec.efficiency>1.5, "efficiency"] = 1.5
		df_Rec.loc[df_Rec.efficiency<0.5, "efficiency"] = 0.5
		df_Rec.loc[df_Rec.efficiency_bh>1.5, "efficiency_bh"] = 1.5
		df_Rec.loc[df_Rec.efficiency_bh<0.5, "efficiency_bh"] = 0.5
		df_Rec.loc[df_Rec.efficiency_vgg>1.5, "efficiency_vgg"] = 1.5
		df_Rec.loc[df_Rec.efficiency_vgg<0.5, "efficiency_vgg"] = 0.5
		df_Rec.loc[df_Rec.efficiency_pi0>1.5, "efficiency_pi0"] = 1.5
		df_Rec.loc[df_Rec.efficiency_pi0<0.5, "efficiency_pi0"] = 0.5
