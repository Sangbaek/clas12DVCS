...
Pphi_efficiency_inb_fd_sector_2_bh   = np.array([1.001]*36)
Pphi_efficiency_inb_fd_sector_3_bh   = np.array([1.001]*36)
Pphi_efficiency_inb_fd_sector_4_bh   = np.array([1.001]*36)
Pphi_efficiency_inb_fd_sector_5_bh   = np.array([1.001]*36)
Pphi_efficiency_inb_fd_sector_6_bh   = np.array([1.001]*36)
Pphi_efficiency_inb_cd_bh            = np.array([1.040, 1.044, 1.109, 1.175, 1.069, 1.025, 0.832, 0.735, 0.780, 0.860, 0.922, 1.023, 1.046, 1.026, 1.008, 1.152, 1.043, 0.864, 0.758, 0.897, 0.942, 0.991, 1.020, 1.030, 0.944, 1.032, 1.027, 1.017, 1.018, 0.928, 0.683, 0.988, 0.955, 1.035, 1.077, 1.042])
...
Pphi_efficiency_outb_cd_bh           = np.array([1.051, 1.031, 1.095, 1.113, 1.043, 1.116, 0.902, 0.890, 0.744, 0.832, 0.924, 1.041, 1.040, 1.057, 1.007, 1.237, 1.071, 0.845, 0.834, 1.133, 0.930, 1.028, 1.142, 1.174, 1.128, 1.187, 1.112, 1.034, 0.968, 0.821, 0.567, 0.796, 0.804, 0.841, 0.838, 0.872])
