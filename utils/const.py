...
collection_cont_xBbins  = [np.linspace(0.05, 0.85, 6), newxBbins, 1]
collection_cont_Q2bins  = [np.array([1, 1.5, 2, 2.5, 3.5, 4.5, 6, 7.5, 10.3]), newQ2bins, 1]
collection_cont_tbins   = [np.array([0.09, 0.2, 0.4, 0.8, 1.8]), newtbins, 1]
collection_cont_phibins = [np.linspace(0, 360, 6), phibins, 1]
