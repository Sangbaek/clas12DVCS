...
if args.question == 0:
  ...
  InbExp_effect_FDFD = len(InbExp.loc[(InbExp.EFid*InbExp.PFid*InbExp.GFid > 0) & (InbExp.config==1), "event"].unique())/len(InbExp.loc[InbExp.config == 1, "event"].unique())
  InbExp_effect_CDFD = len(InbExp.loc[(InbExp.EFid*InbExp.PFid*InbExp.GFid > 0) & (InbExp.config==2), "event"].unique())/len(InbExp.loc[InbExp.config == 2, "event"].unique())
  InbExp_effect_CDFT = len(InbExp.loc[(InbExp.EFid*InbExp.PFid*InbExp.GFid > 0) & (InbExp.config==3), "event"].unique())/len(InbExp.loc[InbExp.config == 3, "event"].unique())
  ...
  InbSim_effect_FDFD = len(InbSim.loc[(InbSim.EFid*InbSim.PFid*InbSim.GFid > 0) & (InbSim.config==1), "event"].unique())/len(InbSim.loc[InbSim.config == 1, "event"].unique())
  InbSim_effect_CDFD = len(InbSim.loc[(InbSim.EFid*InbSim.PFid*InbSim.GFid > 0) & (InbSim.config==2), "event"].unique())/len(InbSim.loc[InbSim.config == 2, "event"].unique())
  InbSim_effect_CDFT = len(InbSim.loc[(InbSim.EFid*InbSim.PFid*InbSim.GFid > 0) & (InbSim.config==3), "event"].unique())/len(InbSim.loc[InbSim.config == 3, "event"].unique())
  ...
  OutbExp_effect_FDFD = len(OutbExp.loc[(OutbExp.EFid*OutbExp.PFid*OutbExp.GFid > 0) & (OutbExp.config==1), "event"].unique())/len(OutbExp.loc[OutbExp.config == 1, "event"].unique())
  OutbExp_effect_CDFD = len(OutbExp.loc[(OutbExp.EFid*OutbExp.PFid*OutbExp.GFid > 0) & (OutbExp.config==2), "event"].unique())/len(OutbExp.loc[OutbExp.config == 2, "event"].unique())
  OutbExp_effect_CDFT = len(OutbExp.loc[(OutbExp.EFid*OutbExp.PFid*OutbExp.GFid > 0) & (OutbExp.config==3), "event"].unique())/len(OutbExp.loc[OutbExp.config == 3, "event"].unique())
  ...
  OutbSim_effect_FDFD = len(OutbSim.loc[(OutbSim.EFid*OutbSim.PFid*OutbSim.GFid > 0) & (OutbSim.config==1), "event"].unique())/len(OutbSim.loc[OutbSim.config == 1, "event"].unique())
  OutbSim_effect_CDFD = len(OutbSim.loc[(OutbSim.EFid*OutbSim.PFid*OutbSim.GFid > 0) & (OutbSim.config==2), "event"].unique())/len(OutbSim.loc[OutbSim.config == 2, "event"].unique())
  OutbSim_effect_CDFT = len(OutbSim.loc[(OutbSim.EFid*OutbSim.PFid*OutbSim.GFid > 0) & (OutbSim.config==3), "event"].unique())/len(OutbSim.loc[OutbSim.config == 3, "event"].unique())
