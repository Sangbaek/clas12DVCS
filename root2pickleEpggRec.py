...
class root2pickle():
    ...
    def __init__(self, fname, entry_start = None, entry_stop = None, pol = "inbending", 
        ...
        smearing = 1, nofid = False, nocorr = False, noeloss = False, nopcorr = False, nogcorr = False,
    ...
    def readEPGG(self, entry_start = None, entry_stop = None, gen = "pi0norad", 
        ...
        if gen == "SIDIS":
            df_pid = pd.DataFrame()
            df_pid["GenPid"] = self.tree["GenPid"].array(library="pd", entry_start=entry_start, entry_stop=entry_stop)
    ...
    def makeDVpi0P(self, pol = "inbending", nofid = False, allowsamesector = False):
        ...
        cut_common = cut_xBupper & cut_xBlower & cut_Q2 & cut_W & cut_Ee & cut_Ge2 & cut_Esector & cut_Psector & cut_Ppmax & cut_Pthetamin & cut_EFid
    ...
    def save(self, raw = False, dvcs = False, pol = "inbending", efficiency = False):
        if raw and not dvcs:
            CD_Ptheta_ub = CD_Ptheta_ub_nominal
            CD_Ptheta_lb = CD_Ptheta_lb_nominal
            FD_Ptheta_inb_ub = FD_Ptheta_inb_ub_nominal
...
if __name__ == "__main__":
    ...
    converter = root2pickle(args.fname, entry_start = args.entry_start, 
        ...
        smearing = smearingFactor, nofid = args.nofid, nocorr = args.nocorr, noeloss = args.noeloss, nopcorr = args.nopcorr,nogcorr = args.nogcorr,
