...
for yind in range(0, 1):
	for xind in range(0, 4):
		...
		# simDist_dvpi0, _ = np.histogram(df2.loc[:, varstoplot[ind]], bins, density = False)
		...
		axs[xind].hist(df2.loc[:,varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='r', density=False, linewidth=1, label = "pass-2, v1\_30, {}".format(len(df2)))
		# axs[xind].hist(df3.loc[:,varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='g', density=False, linewidth=1, label = "pass-2, v1\_30\_2, {}".format(len(df3)))
		axs[xind].set_title(title[ind])
		if (unit[ind]):
			axs[xind].set_xlabel(title[ind]+" [" + unit[ind] +"]")
		else:
			axs[xind].set_xlabel(title[ind])
		axs[xind].set_xlim([bins[0], bins[-1]])
...
axs[1].set_xticks([-0.3, 0, 0.3])
axs[2].set_xlim([-0.01, 0.01])
axs[2].set_xticks([-0.01, 0, 0.01])
axs[3].set_xlim([-0.3, 0.3])
axs[3].set_xticks([-0.3, 0, 0.3])
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/dvcsInbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
plt.clf()
...
axs[1].set_xticks([-0.6, -0.3, 0, 0.3, 0.6])
axs[2].set_xlim([-0.015, 0.015])
axs[2].set_xticks([-0.015, 0, 0.015])
axs[3].set_xlim([-0.3, 0.3])
axs[3].set_xticks([-0.3, 0, 0.3])
# axs[1, 3].set_xlim([0, 0.08])
# axs[1, 3].set_xticks([0, 0.04, 0.08])
...
lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5), title = "RG-A Spring 2019\n" + r"$p'$"+": CD, "+r"$\gamma$"+": FD")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/dvcsInbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
plt.clf()
...
lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5), title = "RG-A Spring 2019\n" + r"$p'$"+": FD, "+r"$\gamma$"+": FD")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/dvcsInbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
plt.clf()
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pass2_CDFT_Pp_Ptheta.pdf")
plt.clf()
...
axs.set_xlabel(r"$\theta_{p'}$" + " [" + degree + "]")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pass2_CDFD_Pp_Ptheta.pdf")
plt.clf()
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pass2_CDprotons_Pp_MM2ep.pdf")
plt.clf()
...
axs.set_ylabel("MM"+r"${}^{2}_{e'p'}$" +" [" + GeV2 + "]")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pass1_CDprotons_Pp_MM2ep.pdf")
plt.clf()
...
axs.set_ylabel("MM"+r"${}^{2}_{e'p'}$" +" [" + GeV2 + "]")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pass2_CDprotons_Ptheta_MM2ep.pdf")
plt.clf()
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pass1_CDprotons_Ptheta_MM2ep.pdf")
plt.clf()
...
# 		bincenters = np.array([0.5 * (bins[i] + bins[i + 1]) for i in range(len(bins) - 1)])
# 		axs[xind].hist(df4[varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='b', density=False, linewidth=1, label = "pass-1, {}".format(len(df1)))
# 		axs[xind].hist(df5[varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='r', density=False, linewidth=1, label = "pass-2, v1\_30, {}".format(len(df2)))
# 		axs[xind].hist(df6[varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='g', density=False, linewidth=1, label = "pass-2, v1\_30, {}".format(len(df2)))
# 		# axs[xind].hist(bins[:-1], bins, weights = simDist, histtype = 'step', color='r', linewidth=1, label = 'Simulation')
# 		axs[xind].set_title(title[ind])
# 		if (unit[ind]):
# 			axs[xind].set_xlabel(title[ind]+" [" + unit[ind] +"]")
...
# plt.tight_layout()
# plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pi0InbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
# plt.clf()
...
# lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
# plt.tight_layout()
# plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pi0InbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
# plt.clf()
...
# lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
# plt.tight_layout()
# plt.savefig("/volatile/clas12/sangbaek/pass2_testing/pi0InbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
# plt.clf()
