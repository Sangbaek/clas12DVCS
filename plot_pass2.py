...
for yind in range(0, 1):
	for xind in range(0, 4):
		...
		# axs[xind].hist(df3.loc[:,varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='g', density=False, linewidth=1, label = "pass-2, v1\_12, {}".format(len(df2)))
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/dvcsInbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
plt.clf()
...
lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5), title = "RG-A Spring 2019\n" + r"$p'$"+": CD, "+r"$\gamma$"+": FD")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/dvcsInbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
plt.clf()
...
lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5), title = "RG-A Spring 2019\n" + r"$p'$"+": FD, "+r"$\gamma$"+": FD")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/dvcsInbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
plt.clf()
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pass2_CDFT_Pp_Ptheta.pdf")
plt.clf()
...
axs.set_xlabel(r"$\theta_{p'}$" + " [" + degree + "]")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pass2_CDFD_Pp_Ptheta.pdf")
plt.clf()
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pass2_CDprotons_Pp_MM2ep.pdf")
plt.clf()
...
axs.set_ylabel("MM"+r"${}^{2}_{e'p'}$" +" [" + GeV2 + "]")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pass1_CDprotons_Pp_MM2ep.pdf")
plt.clf()
...
axs.set_ylabel("MM"+r"${}^{2}_{e'p'}$" +" [" + GeV2 + "]")
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pass2_CDprotons_Ptheta_MM2ep.pdf")
plt.clf()
...
plt.tight_layout()
plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pass1_CDprotons_Ptheta_MM2ep.pdf")
plt.clf()
...
# 		axs[xind].hist(df5[varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='r', density=False, linewidth=1, label = "pass-2, v1\_12, {}".format(len(df2)))
# 		axs[xind].hist(df6[varstoplot[ind]], bins = bins, histtype = 'step', edgecolor='g', density=False, linewidth=1, label = "pass-2, v1\_12, {}".format(len(df2)))
# 		# axs[xind].hist(bins[:-1], bins, weights = simDist, histtype = 'step', color='r', linewidth=1, label = 'Simulation')
# 		axs[xind].set_title(title[ind])
# 		if (unit[ind]):
# 			axs[xind].set_xlabel(title[ind]+" [" + unit[ind] +"]")
...
# plt.tight_layout()
# plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pi0InbCDFTexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
# plt.clf()
...
# lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
# plt.tight_layout()
# plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pi0InbCDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
# plt.clf()
...
# lgd = plt.figlegend(handles,labels, loc='center left', fontsize= 30, title_fontsize = 30, bbox_to_anchor = (1.0, 0.5))
# plt.tight_layout()
# plt.savefig("/volatile/clas12/sangbaek/pass2_test_1108/pi0InbFDexcl.pdf", bbox_extra_artists=[lgd], bbox_inches = 'tight')
# plt.clf()
