...
if __name__ == "__main__":
    ...
    qadb = qadb.loc[qadb.QAresult == 1, ["EventNum", "RunNum", "beamCurrent", "beamQ_QA", "runConfig"]]
    ...
    junks = [5336,5398,5400,5404,5504,5505,5562,5594,5600,5610,5617,5620,5621,5623,5627,5650,5652]
