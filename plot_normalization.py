...
plt.tight_layout()
plt.savefig("plots/normalization/CDFD_Outb_t1.pdf")
plt.clf()
...
plt.legend(loc='lower left', bbox_to_anchor = (0.6, 0.65), framealpha = 0.5)
plt.tight_layout()
plt.savefig("plots/normalization/CDFD_Outb_MM2_ep.pdf")
plt.clf()
...
plt.legend(loc='lower left', bbox_to_anchor = (0.6, 0.65), framealpha = 0.5)
plt.tight_layout()
plt.savefig("plots/normalization/CDFD_Outb_MM2_epOrig.pdf")
plt.clf()
