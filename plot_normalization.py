...
print(contInbCR, contInbCDFT, contInbCD, contInbFD)
print((1-contInbCR)*sum(epgExpInbCR.Esector==1), (1-contInbCDFT)*sum(epgExpInbCDFT.Esector==1)
    , (1-contInbCD)*sum(epgExpInbCD.Esector==1), (1-contInbFD)*sum(epgExpInbFD.Esector==1))
print((1-contInbCR)*sum(epgExpInbCR.Esector==2), (1-contInbCDFT)*sum(epgExpInbCDFT.Esector==2)
    , (1-contInbCD)*sum(epgExpInbCD.Esector==2), (1-contInbFD)*sum(epgExpInbFD.Esector==2))
print((1-contInbCR)*sum(epgExpInbCR.Esector==3), (1-contInbCDFT)*sum(epgExpInbCDFT.Esector==3)
    , (1-contInbCD)*sum(epgExpInbCD.Esector==3), (1-contInbFD)*sum(epgExpInbFD.Esector==3))
print((1-contInbCR)*sum(epgExpInbCR.Esector==4), (1-contInbCDFT)*sum(epgExpInbCDFT.Esector==4)
    , (1-contInbCD)*sum(epgExpInbCD.Esector==4), (1-contInbFD)*sum(epgExpInbFD.Esector==4))
print((1-contInbCR)*sum(epgExpInbCR.Esector==5), (1-contInbCDFT)*sum(epgExpInbCDFT.Esector==5)
    , (1-contInbCD)*sum(epgExpInbCD.Esector==5), (1-contInbFD)*sum(epgExpInbFD.Esector==5))
print((1-contInbCR)*sum(epgExpInbCR.Esector==6), (1-contInbCDFT)*sum(epgExpInbCDFT.Esector==6)
    , (1-contInbCD)*sum(epgExpInbCD.Esector==6), (1-contInbFD)*sum(epgExpInbFD.Esector==6))
print((1-contInbCR)*len(epgExpInbCR)           , (1-contInbCDFT)*len(epgExpInbCDFT)           
    , (1-contInbCD)*len(epgExpInbCD)           , (1-contInbFD)*len(epgExpInbFD)           )

print(sum(bhSimInbCR.Esector==1), sum(bhSimInbCDFT.Esector==1), sum(bhSimInbCD.Esector==1), sum(bhSimInbFD.Esector==1))
print(sum(bhSimInbCR.Esector==2), sum(bhSimInbCDFT.Esector==2), sum(bhSimInbCD.Esector==2), sum(bhSimInbFD.Esector==2))
print(sum(bhSimInbCR.Esector==3), sum(bhSimInbCDFT.Esector==3), sum(bhSimInbCD.Esector==3), sum(bhSimInbFD.Esector==3))
print(sum(bhSimInbCR.Esector==4), sum(bhSimInbCDFT.Esector==4), sum(bhSimInbCD.Esector==4), sum(bhSimInbFD.Esector==4))
print(sum(bhSimInbCR.Esector==5), sum(bhSimInbCDFT.Esector==5), sum(bhSimInbCD.Esector==5), sum(bhSimInbFD.Esector==5))
print(sum(bhSimInbCR.Esector==6), sum(bhSimInbCDFT.Esector==6), sum(bhSimInbCD.Esector==6), sum(bhSimInbFD.Esector==6))
print(len(bhSimInbCR)           , len(bhSimInbCDFT)           , len(bhSimInbCD)           , len(bhSimInbFD)           )

print(sum(dvcsSimInbCR.Esector==1), sum(dvcsSimInbCDFT.Esector==1), sum(dvcsSimInbCD.Esector==1), sum(dvcsSimInbFD.Esector==1))
print(sum(dvcsSimInbCR.Esector==2), sum(dvcsSimInbCDFT.Esector==2), sum(dvcsSimInbCD.Esector==2), sum(dvcsSimInbFD.Esector==2))
print(sum(dvcsSimInbCR.Esector==3), sum(dvcsSimInbCDFT.Esector==3), sum(dvcsSimInbCD.Esector==3), sum(dvcsSimInbFD.Esector==3))
print(sum(dvcsSimInbCR.Esector==4), sum(dvcsSimInbCDFT.Esector==4), sum(dvcsSimInbCD.Esector==4), sum(dvcsSimInbFD.Esector==4))
print(sum(dvcsSimInbCR.Esector==5), sum(dvcsSimInbCDFT.Esector==5), sum(dvcsSimInbCD.Esector==5), sum(dvcsSimInbFD.Esector==5))
print(sum(dvcsSimInbCR.Esector==6), sum(dvcsSimInbCDFT.Esector==6), sum(dvcsSimInbCD.Esector==6), sum(dvcsSimInbFD.Esector==6))
print(len(dvcsSimInbCR)           , len(dvcsSimInbCDFT)           , len(dvcsSimInbCD)           , len(dvcsSimInbFD)           )

print(contOutbCR, contOutbCDFT, contOutbCD, contOutbFD)
print((1-contOutbCR)*sum(epgExpOutbCR.Esector==1), (1-contOutbCDFT)*sum(epgExpOutbCDFT.Esector==1)
    , (1-contOutbCD)*sum(epgExpOutbCD.Esector==1), (1-contOutbFD)*sum(epgExpOutbFD.Esector==1))
print((1-contOutbCR)*sum(epgExpOutbCR.Esector==2), (1-contOutbCDFT)*sum(epgExpOutbCDFT.Esector==2)
    , (1-contOutbCD)*sum(epgExpOutbCD.Esector==2), (1-contOutbFD)*sum(epgExpOutbFD.Esector==2))
print((1-contOutbCR)*sum(epgExpOutbCR.Esector==3), (1-contOutbCDFT)*sum(epgExpOutbCDFT.Esector==3)
    , (1-contOutbCD)*sum(epgExpOutbCD.Esector==3), (1-contOutbFD)*sum(epgExpOutbFD.Esector==3))
print((1-contOutbCR)*sum(epgExpOutbCR.Esector==4), (1-contOutbCDFT)*sum(epgExpOutbCDFT.Esector==4)
    , (1-contOutbCD)*sum(epgExpOutbCD.Esector==4), (1-contOutbFD)*sum(epgExpOutbFD.Esector==4))
print((1-contOutbCR)*sum(epgExpOutbCR.Esector==5), (1-contOutbCDFT)*sum(epgExpOutbCDFT.Esector==5)
    , (1-contOutbCD)*sum(epgExpOutbCD.Esector==5), (1-contOutbFD)*sum(epgExpOutbFD.Esector==5))
print((1-contOutbCR)*sum(epgExpOutbCR.Esector==6), (1-contOutbCDFT)*sum(epgExpOutbCDFT.Esector==6)
    , (1-contOutbCD)*sum(epgExpOutbCD.Esector==6), (1-contOutbFD)*sum(epgExpOutbFD.Esector==6))
print((1-contOutbCR)*len(epgExpOutbCR)           , (1-contOutbCDFT)*len(epgExpOutbCDFT)           
    , (1-contOutbCD)*len(epgExpOutbCD)           , (1-contOutbFD)*len(epgExpOutbFD)           )

print(sum(bhSimOutbCR.Esector==1), sum(bhSimOutbCDFT.Esector==1), sum(bhSimOutbCD.Esector==1), sum(bhSimOutbFD.Esector==1))
print(sum(bhSimOutbCR.Esector==2), sum(bhSimOutbCDFT.Esector==2), sum(bhSimOutbCD.Esector==2), sum(bhSimOutbFD.Esector==2))
print(sum(bhSimOutbCR.Esector==3), sum(bhSimOutbCDFT.Esector==3), sum(bhSimOutbCD.Esector==3), sum(bhSimOutbFD.Esector==3))
print(sum(bhSimOutbCR.Esector==4), sum(bhSimOutbCDFT.Esector==4), sum(bhSimOutbCD.Esector==4), sum(bhSimOutbFD.Esector==4))
print(sum(bhSimOutbCR.Esector==5), sum(bhSimOutbCDFT.Esector==5), sum(bhSimOutbCD.Esector==5), sum(bhSimOutbFD.Esector==5))
print(sum(bhSimOutbCR.Esector==6), sum(bhSimOutbCDFT.Esector==6), sum(bhSimOutbCD.Esector==6), sum(bhSimOutbFD.Esector==6))
print(len(bhSimOutbCR)           , len(bhSimOutbCDFT)           , len(bhSimOutbCD)           , len(bhSimOutbFD)           )

print(sum(dvcsSimOutbCR.Esector==1), sum(dvcsSimOutbCDFT.Esector==1), sum(dvcsSimOutbCD.Esector==1), sum(dvcsSimOutbFD.Esector==1))
print(sum(dvcsSimOutbCR.Esector==2), sum(dvcsSimOutbCDFT.Esector==2), sum(dvcsSimOutbCD.Esector==2), sum(dvcsSimOutbFD.Esector==2))
print(sum(dvcsSimOutbCR.Esector==3), sum(dvcsSimOutbCDFT.Esector==3), sum(dvcsSimOutbCD.Esector==3), sum(dvcsSimOutbFD.Esector==3))
print(sum(dvcsSimOutbCR.Esector==4), sum(dvcsSimOutbCDFT.Esector==4), sum(dvcsSimOutbCD.Esector==4), sum(dvcsSimOutbFD.Esector==4))
print(sum(dvcsSimOutbCR.Esector==5), sum(dvcsSimOutbCDFT.Esector==5), sum(dvcsSimOutbCD.Esector==5), sum(dvcsSimOutbFD.Esector==5))
print(sum(dvcsSimOutbCR.Esector==6), sum(dvcsSimOutbCDFT.Esector==6), sum(dvcsSimOutbCD.Esector==6), sum(dvcsSimOutbFD.Esector==6))
print(len(dvcsSimOutbCR)           , len(dvcsSimOutbCDFT)           , len(dvcsSimOutbCD)           , len(dvcsSimOutbFD)           )
